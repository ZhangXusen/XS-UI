...
var lt,
  ...
  Xe = {},
  _n = [],
  ii = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function K(t, e) {
...
function ee(t, e, r) {
  ...
  if (
    (arguments.length > 2 &&
      (o.children = arguments.length > 3 ? lt.call(arguments, 2) : r),
    typeof t == "function" && t.defaultProps != null)
  )
    for (i in t.defaultProps) o[i] === void 0 && (o[i] = t.defaultProps[i]);
...
function me(t, e) {
  if (e == null) return t.__ ? me(t.__, t.__.__k.indexOf(t) + 1) : null;
...
function Nt(t) {
  ((!t.__d && (t.__d = !0) && Te.push(t) && !$e.__r++) ||
    Sr !== w.debounceRendering) &&
    ((Sr = w.debounceRendering) || setTimeout)($e);
}
function $e() {
...
function In(t, e, r, n, a, i, o, s, l, u) {
  var c,
    d,
    f,
    v,
  ...
  for (r.__k = [], c = 0; c < e.length; c++)
    if (
      (v = r.__k[c] =
        (v = e[c]) == null || typeof v == "boolean"
          ? null
          : typeof v == "string" || typeof v == "number" || typeof v == "bigint"
          ? qe(null, v, null, null, v)
          : Array.isArray(v)
          ? qe(se, { children: v }, null, null, null)
          : v.__b > 0
          ? qe(v.type, v.props, v.key, null, v.__v)
          : v) != null
    ) {
      if (
        ((v.__ = r),
        (v.__b = r.__b + 1),
        (f = g[c]) === null || (f && v.key == f.key && v.type === f.type))
      )
        g[c] = void 0;
      else
        for (d = 0; d < b; d++) {
          if ((f = g[d]) && v.key == f.key && v.type === f.type) {
            g[d] = void 0;
            break;
          }
          f = null;
        }
      jt(t, v, (f = f || Xe), a, i, o, s, l, u),
        (p = v.__e),
        (d = v.ref) &&
          f.ref != d &&
          (S || (S = []),
          f.ref && S.push(f.ref, null, v),
          S.push(d, v.__c || p, v)),
        p != null
          ? (E == null && (E = p),
            typeof v.type == "function" && v.__k === f.__k
              ? (v.__d = l = Pn(v, l, t))
              : (l = Hn(t, v, f, g, p, l)),
            typeof r.type == "function" && (r.__d = l))
          : l && f.__e == l && l.parentNode != t && (l = me(f));
    }
  for (r.__e = E, c = b; c--; )
    g[c] != null &&
      (typeof r.type == "function" &&
        ...
        (r.__d = me(n, c + 1)),
      Nn(g[c], g[c]));
  if (S) for (c = 0; c < S.length; c++) An(S[c], S[++c], S[++c]);
}
function Pn(t, e, r) {
  for (var n, a = t.__k, i = 0; a && i < a.length; i++)
    (n = a[i]) &&
      ((n.__ = t),
      (e =
        typeof n.type == "function" ? Pn(n, e, r) : Hn(r, n, n, a, n.__e, e)));
  return e;
}
function Ke(t, e) {
  return (
...
function Hn(t, e, r, n, a, i) {
  ...
  if (e.__d !== void 0) (o = e.__d), (e.__d = void 0);
    ...
    e: if (i == null || i.parentNode !== t) t.appendChild(a), (o = null);
    else {
...
function br(t, e, r) {
  e[0] === "-"
    ? t.setProperty(e, r)
    : (t[e] =
        r == null ? "" : typeof r != "number" || ii.test(e) ? r : r + "px");
}
  ...
  e: if (e === "style")
    if (typeof r == "string") t.style.cssText = r;
      ...
      if ((typeof n == "string" && (t.style.cssText = n = ""), n))
        for (e in n) (r && e in r) || br(t.style, e, "");
    ...
    (i = e !== (e = e.replace(/Capture$/, ""))),
      ...
      (t.l[e + i] = r),
      r
        ? n || t.addEventListener(e, i ? Cr : Dr, i)
        : t.removeEventListener(e, i ? Cr : Dr, i);
...
function jt(t, e, r, n, a, i, o, s, l) {
  ...
  r.__h != null &&
    ((l = r.__h), (s = e.__e = r.__e), (e.__h = null), (i = [s])),
    (u = w.__b) && u(e);
  try {
    e: if (typeof T == "function") {
      if (
        ((S = e.props),
        (g = (u = T.contextType) && n[u.__c]),
        (b = u ? (g ? g.props.value : u.__) : n),
        r.__c
          ? (E = (c = e.__c = r.__c).__ = c.__E)
        ...
        T.getDerivedStateFromProps != null &&
          (c.__s == c.state && (c.__s = K({}, c.__s)),
          K(c.__s, T.getDerivedStateFromProps(S, c.__s))),
        (f = c.props),
        (v = c.state),
        d)
      )
        ...
        if (
          (T.getDerivedStateFromProps == null &&
            ...
            c.componentWillReceiveProps(S, b),
          (!c.__e &&
            c.shouldComponentUpdate != null &&
            c.shouldComponentUpdate(S, c.__s, b) === !1) ||
            e.__v === r.__v)
        ) {
          (c.props = S),
            (c.state = c.__s),
            ...
            (e.__e = r.__e),
            (e.__k = r.__k),
            e.__k.forEach(function (P) {
              P && (P.__ = e);
            }),
            c.__h.length && o.push(c);
          break e;
        }
        c.componentWillUpdate != null && c.componentWillUpdate(S, c.__s, b),
          c.componentDidUpdate != null &&
            c.__h.push(function () {
              c.componentDidUpdate(f, v, p);
            });
      }
      if (
        ((c.context = b),
        ...
        while (c.__d && ++C < 25);
      (c.state = c.__s),
        c.getChildContext != null && (n = K(K({}, n), c.getChildContext())),
        d ||
          c.getSnapshotBeforeUpdate == null ||
          (p = c.getSnapshotBeforeUpdate(f, v)),
        (k =
          u != null && u.type === se && u.key == null ? u.props.children : u),
        In(t, Array.isArray(k) ? k : [k], e, r, n, a, i, o, s, l),
        (c.base = e.__e),
        (e.__h = null),
        c.__h.length && o.push(c),
        E && (c.__E = c.__ = null),
...
function li(t, e, r, n, a, i, o, s) {
  ...
  if (v === null) d === f || (s && t.data === f) || (t.data = f);
  else {
    if (
      ((i = i && lt.call(t.childNodes)),
      (u = (d = r.props || Xe).dangerouslySetInnerHTML),
    ...
    if ((si(t, f, d, a, s), c)) e.__k = [];
      ...
      for (p = i.length; p--; ) i[p] != null && Mn(i[p]);
    s ||
      ("value" in f &&
        (p = f.value) !== void 0 &&
        (p !== t.value ||
          (v === "progress" && !p) ||
          (v === "option" && p !== d.value)) &&
        Je(t, "value", p, d.value, !1),
      "checked" in f &&
        (p = f.checked) !== void 0 &&
        p !== t.checked &&
        Je(t, "checked", p, d.checked, !1));
  }
  return t;
}
function An(t, e, r) {
...
function Nn(t, e, r) {
  ...
  if (
    ...
    (n = t.ref) && ((n.current && n.current !== t.__e) || An(n, null, e)),
    (n = t.__c) != null)
  ) {
  ...
  if ((n = t.__k))
    for (a = 0; a < n.length; a++)
      n[a] && Nn(n[a], e, typeof t.type != "function");
  r || t.__e == null || Mn(t.__e), (t.__e = t.__d = void 0);
}
function ui(t, e, r) {
...
function He(t, e, r) {
  var n, a, i;
  w.__ && w.__(t, e),
    (a = (n = typeof r == "function") ? null : (r && r.__k) || e.__k),
    (i = []),
    jt(
      e,
      (t = ((!n && r) || e).__k = ee(se, null, [t])),
      a || Xe,
      Xe,
      e.ownerSVGElement !== void 0,
      !n && r ? [r] : a ? null : e.firstChild ? lt.call(e.childNodes) : null,
      i,
      !n && r ? r : a ? a.__e : e.firstChild,
      n
    ),
    xn(i, t);
}
...
(lt = _n.slice),
          ...
          try {
            if (
              ((i = a.constructor) &&
                ...
                (a.setState(i.getDerivedStateFromError(t)), (o = a.__d)),
              a.componentDidCatch != null &&
                (a.componentDidCatch(t, n || {}), (o = a.__d)),
              o)
            )
              return (a.__E = a);
          } catch (s) {
  ...
  (q.prototype.setState = function (t, e) {
    ...
    (r =
      ...
      typeof t == "function" && (t = t(K({}, r), this.props)),
      t && K(r, t),
      t != null && this.__v && (e && this.__h.push(e), Nt(this));
  }),
  (q.prototype.forceUpdate = function (t) {
    this.__v && ((this.__e = !0), t && this.__h.push(t), Nt(this));
  }),
  (q.prototype.render = se),
  (Te = []),
  ($e.__r = 0),
  (Tn = 0);
var j,
  ...
  (w.__r = function (t) {
    ...
    e &&
      (yt === j
        ...
        : (e.__h.forEach(Ye), e.__h.forEach(Ot), (e.__h = []))),
      (yt = j);
  }),
  (w.diffed = function (t) {
    _r && _r(t);
    ...
    e &&
      e.__H &&
      (e.__H.__h.length &&
        ((On.push(e) !== 1 && Rr === w.requestAnimationFrame) ||
          (
            (Rr = w.requestAnimationFrame) ||
            function (r) {
              var n,
                a = function () {
...
((Hr.prototype = new q()).isPureReactComponent = !0),
  (Hr.prototype.shouldComponentUpdate = function (t, e) {
  ...
  ((St.prototype = new q()).__c = function (t, e) {
    ...
    var s = function () {
        if (!--n.__u) {
          if (n.state.__a) {
            var u = n.state.__a;
            n.__v.__k[0] = (function d(f, v, p) {
              return (
                f &&
                  ((f.__v = null),
                  (f.__k =
                    f.__k &&
                    f.__k.map(function (E) {
                      return d(E, v, p);
                    })),
                  f.__c &&
                    f.__c.__P === v &&
                    (f.__e && p.insertBefore(f.__e, f.__d),
                    (f.__c.__e = !0),
                    (f.__c.__P = p))),
                f
              );
        ...
        this.__v.__k[0] = (function i(o, s, l) {
          return (
            o &&
              (o.__c &&
                o.__c.__H &&
                (o.__c.__H.__.forEach(function (u) {
                  typeof u.__c == "function" && u.__c();
                }),
                (o.__c.__H = null)),
              (o = fi({}, o)).__c != null &&
                (o.__c.__P === l && (o.__c.__P = s), (o.__c = null)),
              (o.__k =
                o.__k &&
                o.__k.map(function (u) {
                  return i(u, s, l);
                }))),
            o
          );
  ...
  (e.componentWillUnmount = function () {
    ...
    t.__v
      ? (e.l ||
        ...
        He(ee(pi, { context: e.context }, t.__v), e.l))
      : e.l && e.componentWillUnmount();
}
function gi(t, e) {
  var r = ee(hi, { __v: t, i: e });
...
w.event = function (t) {
  return (
    Or && (t = Or(t)),
    (t.persist = bi),
    (t.isPropagationStopped = Di),
    (t.isDefaultPrevented = Ci),
    (t.nativeEvent = t)
  );
};
var Lr = {
...
w.vnode = function (t) {
  ...
  if (typeof e == "string") {
    ...
    for (var i in ((n = {}), r)) {
      var o = r[i];
      (Ei && i === "children" && e === "noscript") ||
        (i === "value" && "defaultValue" in r && o == null) ||
        (i === "defaultValue" && "value" in r && r.value == null
          ...
          ? (i = "ondblclick")
          : /^onchange(textarea|input)/i.test(i + e) && !Si(r.type)
          ? (i = "oninput")
          : /^onfocus$/i.test(i)
          ? (i = "onfocusin")
          : /^onblur$/i.test(i)
    ...
    e == "select" &&
      ...
      (n.value = Ke(r.children).forEach(function (s) {
      ...
      (t.props = n),
      r.class != r.className &&
        ((Lr.enumerable = "className" in r),
        r.className != null && (n.class = r.className),
        Object.defineProperty(n, "className", Lr));
  }
  (t.$$typeof = mi), Vr && Vr(t);
};
var Ur = w.__r;
...
Wr.FullCalendarVDom
  ...
  : (Wr.FullCalendarVDom = {
      ...
      createPortal: gi,
      flushSync: Ri,
      unmountComponentAtNode: _i,
    });
function Ri(t) {
  t();
  var e = w.debounceRendering,
    r = [];
  function n(a) {
    r.push(a);
  }
  for (
    w.debounceRendering = n, He(ee(wi, {}), document.createElement("div"));
    r.length;
...
var Zt = FullCalendarVDom.Component,
  m = FullCalendarVDom.createElement,
  Mi = FullCalendarVDom.render,
  G = FullCalendarVDom.createRef,
  B = FullCalendarVDom.Fragment,
  Vn = FullCalendarVDom.createContext,
  ki = FullCalendarVDom.createPortal,
  Br = FullCalendarVDom.flushSync,
  Ii = FullCalendarVDom.unmountComponentAtNode;
/*!
...
function Hi(t, e) {
  for (
    var r = t instanceof HTMLElement ? [t] : t, n = [], a = 0;
    a < r.length;
    a += 1
  )
...
var xi = /(top|left|right|bottom|width|height)$/i;
function _e(t, e) {
  for (var r in e) Un(t, r, e[r]);
}
function Un(t, e, r) {
  r == null
    ? (t.style[e] = "")
    : typeof r == "number" && xi.test(e)
    ? (t.style[e] = r + "px")
    : (t.style[e] = r);
}
function Wn(t) {
...
function Ni(t, e, r, n) {
  var a;
  return Fn(t, "mouseover", e, function (i, o) {
    if (o !== a) {
      (a = o), r(i, o);
      var s = function (l) {
...
function Vi(t) {
  t.classList.remove("fc-unselectable"),
    t.removeEventListener("selectstart", ct);
}
function Ui(t) {
  ...
  for (
    ...
    (a = r[n]),
      typeof a == "string"
        ? e.push(
            a.charAt(0) === "-"
              ? { field: a.substring(1), order: -1 }
              : { field: a, order: 1 }
          )
        : typeof a == "function" && e.push({ func: a });
  return e;
}
function Fi(t, e, r) {
  var n, a;
  for (n = 0; n < r.length; n += 1) if (((a = zi(t, e, r[n])), a)) return a;
  return 0;
}
function zi(t, e, r) {
  return r.func ? r.func(t, e) : Gi(t[r.field], e[r.field]) * (r.order || 1);
}
function Gi(t, e) {
  return !t && !e
    ? 0
...
function Yi(t) {
  var e = t.querySelector(".fc-scrollgrid-shrink-frame"),
    r = t.querySelector(".fc-scrollgrid-shrink-cushion");
  if (!e) throw new Error("needs fc-scrollgrid-shrink-frame className");
  if (!r) throw new Error("needs fc-scrollgrid-shrink-cushion className");
  return (
...
function H(t) {
  return F([t.getUTCFullYear(), t.getUTCMonth(), t.getUTCDate()]);
}
function eo(t) {
  return F([
    t.getUTCFullYear(),
...
function no(t, e, r) {
  var n = t.getUTCFullYear(),
    a = Ct(t, n, e, r);
  if (a < 1) return Ct(t, n - 1, e, r);
  var i = Ct(t, n + 1, e, r);
  return i >= 1 ? Math.min(a, i) : a;
}
function Ct(t, e, r, n) {
  var a = F([e, 0, 1 + ao(e, r, n)]),
    i = H(t),
    o = Math.round(De(a, i));
...
function F(t) {
  return (
    t.length === 1 && (t = t.concat([0])), new Date(Date.UTC.apply(Date, t))
  );
}
function qn(t) {
...
function Qt(t, e) {
  ...
  if (e)
    for (var n in e) {
      for (var a = [], i = t.length - 1; i >= 0; i -= 1) {
        var o = t[i][n];
        if (typeof o == "object" && o) a.unshift(o);
        else if (o !== void 0) {
          r[n] = o;
          break;
        }
  ...
  for (var i = t.length - 1; i >= 0; i -= 1) {
    var s = t[i];
    for (var l in s) l in r || (r[l] = s[l]);
  }
  return r;
}
function ue(t, e) {
  var r = {};
  for (var n in t) e(t[n], n) && (r[n] = t[n]);
  return r;
}
function ce(t, e) {
  var r = {};
  for (var n in t) r[n] = e(t[n], n);
  return r;
}
function Yn(t) {
...
function X(t, e) {
  if (t === e) return !0;
  for (var r in t) if (et.call(t, r) && !(r in e)) return !1;
  for (var r in e) if (et.call(e, r) && t[r] !== e[r]) return !1;
  return !0;
}
function Zr(t, e) {
  var r = [];
  for (var n in t) et.call(t, n) && (n in e || r.push(n));
  for (var n in e) et.call(e, n) && t[n] !== e[n] && r.push(n);
  return r;
}
function Rt(t, e, r) {
  if ((r === void 0 && (r = {}), t === e)) return !0;
  for (var n in e) if (!(n in t && io(t[n], e[n], r[n]))) return !1;
...
function so(t, e, r, n) {
  for (var a = 0; a < n.length; a += 1) {
    ...
    if (i) {
      ...
      return (
        o == null &&
          ((o = e), o == null && ((o = i.allDayGuess), o == null && (o = !1))),
        { allDay: o, duration: i.duration, typeData: i.typeData, typeId: a }
      );
    }
  }
  return null;
...
function ye(t, e, r) {
  ...
  for (var l in o) {
    ...
    if (u.recurringDef) {
      ...
      for (
        var d = lo(u, c, e, n, a.recurringTypes), f = 0, v = d;
        f < v.length;
        f++
      ) {
        var p = v[f],
          E = Jt(l, { start: p, end: n.add(p, c) });
        s[E.instanceId] = E;
      }
    }
  }
...
function lo(t, e, r, n, a) {
  var i = a[t.recurringDef.typeId],
    o = i.expand(
      t.recurringDef.typeData,
      { start: n.subtract(r.start, e), end: r.end },
      n
    );
  return t.allDay && (o = o.map(H)), o;
}
var uo = /^(-?)(?:(\d+)\.)?(\d+):(\d\d)(?::(\d\d)(?:\.(\d\d\d))?)?/;
function I(t, e) {
  var r;
...
function Ee(t, e, r) {
  ...
  for (a = 0; a < n; a += 1)
    if (!(r ? r(t[a], e[a]) : t[a] === e[a])) return !1;
  return !0;
}
function M(t, e, r) {
  var n, a;
...
var $r = {
  ...
  bo = (function () {
    function t(e) {
      ...
      for (var i in e)
        i in $r
          ? ((n[i] = e[i]), (a = Math.max($r[i], a)))
          : ((r[i] = e[i]), i in tt && (a = Math.max(tt[i], a)));
      (this.standardDateProps = r),
        (this.extendedSettings = n),
        (this.severity = a),
        (this.buildFormattingFunc = M(Kr));
    }
    return (
      (t.prototype.format = function (e, r) {
      ...
      (t.prototype.formatRange = function (e, r, n, a) {
        var i = this,
          ...
          s = i.extendedSettings,
          l = _o(e.marker, r.marker, n.calendarSystem);
        if (!l) return this.format(e, n);
        var u = l;
        u > 1 &&
          (o.year === "numeric" || o.year === "2-digit") &&
          (o.month === "numeric" || o.month === "2-digit") &&
          (o.day === "numeric" || o.day === "2-digit") &&
          (u = 1);
        ...
        var f = Mo(o, u),
          ...
          E = v(r),
          S = ko(c, p, d, E),
          g = s.separator || a || n.defaultSeparator || "";
        return S ? S.before + p + g + E + S.after : c + g + d;
      }),
...
function Kr(t, e, r) {
  ...
  return n === 1 && t.timeZoneName === "short"
    ? function (a) {
...
function Do(t, e, r) {
  (t = h({}, t)), (e = h({}, e)), Co(t, e), (t.timeZone = "UTC");
  var n = new Intl.DateTimeFormat(r.locale.codes, t),
    a;
  if (e.omitZeroMinute) {
    var i = h({}, t);
...
function Ro(t, e, r, n, a) {
  return (
    ...
    r.timeZoneName === "short" &&
      (t = wo(
        t,
        a.timeZone === "UTC" || e.timeZoneOffset == null
          ? "UTC"
          : tr(e.timeZoneOffset)
      )),
    n.omitCommas && (t = t.replace(mo, "").trim()),
    n.omitZeroMinute && (t = t.replace(":00", "")),
    n.meridiem === !1
      ? (t = t.replace(Be, "").trim())
      : n.meridiem === "narrow"
      ? (t = t.replace(Be, function (i, o) {
      ...
      : n.meridiem === "lowercase" &&
        (t = t.replace(Be, function (i) {
...
function To(t, e, r, n, a) {
  var i = [];
  return (
    a === "long" ? i.push(r) : (a === "short" || a === "narrow") && i.push(e),
    (a === "long" || a === "short") && i.push(" "),
    i.push(n.simpleNumberFormat.format(t)),
    n.options.direction === "rtl" && i.reverse(),
    i.join("")
  );
}
function _o(t, e, r) {
  return r.getMarkerYear(t) !== r.getMarkerYear(e)
    ? 5
    : r.getMarkerMonth(t) !== r.getMarkerMonth(e)
    ? 4
    : r.getMarkerDay(t) !== r.getMarkerDay(e)
    ? 2
    : Q(t) !== Q(e)
    ? 1
    : 0;
...
function Mo(t, e) {
  var r = {};
  for (var n in t) (!(n in tt) || tt[n] <= e) && (r[n] = t[n]);
  return r;
}
function ko(t, e, r, n) {
  for (var a = 0; a < t.length; ) {
    ...
    for (var s = t.substr(a), l = 0; l < r.length; ) {
      ...
      l = u + n.length;
      var d = r.substr(l);
      if (o === c && s === d) return { before: o, after: s };
    }
  }
  return null;
}
...
function rt(t, e, r, n) {
  var a = Jr(t, r.calendarSystem),
    i = e ? Jr(e, r.calendarSystem) : null;
  return {
    date: a,
    start: a,
    end: i,
...
function rr(t, e) {
  var r = {},
    n = {};
  for (var a in e) a in t && (r[a] = e[a](t[a]));
...
function Ao(t, e) {
  var r = t.defs,
    ...
    a = {},
    i = {};
  for (var o in r) e.defs[o] || (a[o] = r[o]);
  for (var s in n) !e.instances[s] && a[n[s].defId] && (i[s] = n[s]);
...
var Ze = {
  ...
  Zn = { start: y, end: y, date: y, allDay: Boolean },
  Uo = h(h(h({}, Ze), Zn), { extendedProps: y });
function Xn(t, e, r, n, a) {
  ...
  var i = $n(t, r, a),
    ...
    s = i.extra,
    l = Bo(e, r),
    u = so(o, l, r.dateEnv, r.pluginHooks.recurringTypes);
  if (u) {
  ...
  var d = Wo(o, l, r, n);
  if (d) {
    var c = Wt(o, s, e ? e.sourceId : "", d.allDay, d.hasEnd, r),
      f = Jt(c.defId, d.range, d.forcedStartTzo, d.forcedEndTzo);
...
function ir(t) {
  return h(h(h({}, at), Uo), t.pluginHooks.eventRefiners);
}
...
function Wo(t, e, r, n) {
  ...
  if (((i = r.dateEnv.createMarkerMeta(c)), i)) o = i.marker;
  else if (!n) return null;
  return (
    t.end != null && (l = r.dateEnv.createMarkerMeta(t.end)),
    a == null &&
      (e != null
        ? (a = e)
        : (a = (!i || i.isTimeUnspecified) && (!l || l.isTimeUnspecified))),
    a && o && (o = H(o)),
    l && ((u = l.marker), a && (u = H(u)), o && u <= o && (u = null)),
    u
      ? (s = !0)
      : n ||
        ((s = r.options.forceEventDuration || !1),
        (u = r.dateEnv.add(
          o,
          a
            ? r.options.defaultAllDayEventDuration
            : r.options.defaultTimedEventDuration
        ))),
    {
      allDay: a,
      hasEnd: s,
...
function Bo(t, e) {
  var r = null;
  return (
    t && (r = t.defaultAllDay), r == null && (r = e.options.defaultAllDay), r
  );
}
function Kn(t) {
  var e = Math.floor(De(t.start, t.end)) || 1,
    r = H(t.start),
    n = W(r, e);
...
function Jn(t, e) {
  ...
  return (
    t.start && ((r = H(t.start)), n && n <= r && (n = W(r, 1))),
    { start: r, end: n }
  );
}
function pe(t, e, r, n) {
  return n === "year"
    ? I(r.diffWholeYears(t, e), "year")
    : n === "month"
    ? I(r.diffWholeMonths(t, e), "month")
    : Ji(t, e);
}
function Fo(t, e) {
  var r = null,
    n = null;
  return (
    t.start && (r = e.createMarker(t.start)),
    t.end && (n = e.createMarker(t.end)),
    (!r && !n) || (r && n && n < r) ? null : { start: r, end: n }
  );
}
function rn(t, e) {
  var r = [],
    ...
    a,
    i;
  for (t.sort(zo), a = 0; a < t.length; a += 1)
    (i = t[a]),
      i.start > n && r.push({ start: n, end: i.start }),
      i.end > n && (n = i.end);
...
function Ae(t, e) {
  ...
  return (
    e.start !== null &&
      (r === null
        ? (r = e.start)
        : (r = new Date(Math.max(r.valueOf(), e.start.valueOf())))),
    e.end != null &&
      (n === null
        ? (n = e.end)
        : (n = new Date(Math.min(n.valueOf(), e.end.valueOf())))),
    (r === null || n === null || r < n) && (a = { start: r, end: n }),
    a
  );
}
function Go(t, e) {
...
function nn(t, e, r, n) {
  ...
  for (var c in t.defs) {
    ...
    f.display === "inverse-background" &&
      (d.groupId
        ? ((a[d.groupId] = []), o[d.groupId] || (o[d.groupId] = d))
        : (i[c] = []));
  }
...
function jo(t) {
  var e = t.eventRange,
    r = e.def,
    n = e.instance ? e.instance.range : e.range,
    a = n.start ? n.start.valueOf() : 0,
...
function ea(t, e, r, n, a, i, o) {
  ...
  var v = f.range.start,
    p = f.range.end,
    E = i || t.start || t.eventRange.range.start,
    S = o || t.end || t.eventRange.range.end,
    g = H(v).valueOf() === H(E).valueOf(),
    b = H(le(p, -1)).valueOf() === H(le(S, -1)).valueOf();
  return u && !d.allDay && (g || b)
    ? ((E = g ? v : E),
      (S = b ? p : S),
      c && d.hasEnd
        ? s.formatRange(E, S, e, {
        ...
        : s.format(E, e, { forcedTzo: i ? null : f.forcedStartTzo }))
    : "";
}
function Ie(t, e, r) {
...
function ta(t, e) {
  ...
  var o = e.emitter,
    s = e.options,
    l = s.eventInteractive;
  return (
    l == null &&
      ((l = n.interactive),
      l == null && (l = Boolean(o.hasHandlers("eventClick")))),
    l
      ? Gn(function (u) {
...
var Qo = { start: y, end: y, allDay: Boolean };
function es(t, e, r) {
  var n = ts(t, e),
    a = n.range;
...
function ts(t, e) {
  var r = rr(t, Qo),
    ...
    o = n.end ? e.createMarkerMeta(n.end) : null,
    s = n.allDay;
  return (
    s == null && (s = i && i.isTimeUnspecified && (!o || o.isTimeUnspecified)),
    h(
      {
...
function rs(t, e) {
  return Go(t.range, e.range) && t.allDay === e.allDay && ns(t, e);
}
function ns(t, e) {
  for (var r in e)
    if (r !== "range" && r !== "allDay" && t[r] !== e[r]) return !1;
  for (var r in t) if (!(r in e)) return !1;
  return !0;
}
function as(t, e) {
  return h(h({}, na(t.range, e, t.allDay)), { allDay: t.allDay });
}
function ra(t, e, r) {
  return h(h({}, na(t, e, r)), { timeZone: e.timeZone });
}
function na(t, e, r) {
  return {
...
function is(t, e, r) {
  var n = $n({ editable: !1 }, r),
    a = Wt(n.refined, n.extra, "", t.allDay, !0, r);
  return {
    def: a,
    ui: Qn(a, e),
...
function sr(t, e) {
  for (
    var r = {}, n = 0, a = e.pluginHooks.dateSpanTransforms;
    n < a.length;
    n++
  ) {
    var i = a[n];
...
function on(t, e, r) {
  ...
  return (
    t
      ? ((i = H(i)), (i = n.add(i, a.defaultAllDayEventDuration)))
      : (i = n.add(i, a.defaultTimedEventDuration)),
    i
  );
}
function lr(t, e, r, n) {
  ...
  for (var o in t.defs) {
    var s = t.defs[o];
    i.defs[o] = ss(s, a[o], r, n);
  }
  for (var l in t.instances) {
    var u = t.instances[l],
      s = i.defs[u.defId];
    i.instances[l] = ls(u, s, a[u.defId], r, n);
  }
  return i;
}
function ss(t, e, r, n) {
  ...
  r.extendedProps &&
    (i.extendedProps = h(h({}, i.extendedProps), r.extendedProps));
  for (
    var o = 0, s = n.pluginHooks.eventDefMutationAppliers;
    o < s.length;
    o++
  ) {
    var l = s[o];
...
function ls(t, e, r, n, a) {
  var i = a.dateEnv,
    o = n.standardProps && n.standardProps.allDay === !0,
    s = n.standardProps && n.standardProps.hasEnd === !1,
    l = h({}, t);
  return (
    o && (l.range = Kn(l.range)),
    n.datesDelta &&
      r.startEditable &&
      (l.range = {
    ...
    n.endDelta &&
      r.durationEditable &&
      (l.range = { start: l.range.start, end: i.add(l.range.end, n.endDelta) }),
    s &&
      (l.range = { start: l.range.start, end: on(e.allDay, l.range.start, a) }),
    e.allDay && (l.range = { start: H(l.range.start), end: H(l.range.end) }),
    l.range.end < l.range.start &&
      (l.range.end = on(e.allDay, l.range.start, a)),
    l
  );
}
var us = (function () {
...
function oa(t) {
  return h(h(h({}, at), cs), t.pluginHooks.eventSourceRefiners);
}
function ds(t, e) {
  for (
    var r = e.pluginHooks.eventSourceDefs, n = r.length - 1;
    n >= 0;
    n -= 1
  ) {
    var a = r[n],
      i = a.parseMeta(t);
    if (i) return { sourceDefId: n, meta: i };
  }
  return null;
}
function fs(t, e) {
...
var ps = (function () {
    ...
    return (
      ...
      (t.prototype.setOption = function (e, r) {
        this.dispatch({ type: "SET_OPTION", optionName: e, rawOptionValue: r });
      }),
      (t.prototype.getOption = function (e) {
      ...
      (t.prototype.zoomTo = function (e, r) {
        var n = this.getCurrentData(),
          a;
        (r = r || "day"),
          (a = n.viewSpecs[r] || this.getUnitViewSpec(r)),
          this.unselect(),
          a
            ? this.dispatch({
                type: "CHANGE_VIEW_TYPE",
      ...
      (t.prototype.getUnitViewSpec = function (e) {
        var r = this.getCurrentData(),
          ...
          o,
          s;
        for (var l in n) i.push(l);
        for (o = 0; o < i.length; o += 1)
          if (((s = n[i[o]]), s && s.singleUnit === e)) return s;
        return null;
      }),
      ...
      (t.prototype.unselect = function (e) {
        var r = this.getCurrentData();
        r.dateSelection &&
          (this.dispatch({ type: "UNSELECT_DATES" }), os(e, r));
      }),
      (t.prototype.addEvent = function (e, r) {
        ...
        var o = this.getCurrentData(),
          s;
        if (r instanceof ve) s = r.internalEventSource;
        else if (typeof r == "boolean") r && (s = er(o.eventSources)[0]);
        else if (r != null) {
          var l = this.getEventSourceById(r);
          if (!l)
            return (
              console.warn(
                'Could not find an event source with ID "' + r + '"'
              ),
              null
            );
        ...
        if (u) {
          ...
          return (
            this.dispatch({ type: "ADD_EVENTS", eventStore: Vt(u) }),
            this.triggerEventAdd(c),
            c
          );
        }
        return null;
      ...
      (t.prototype.triggerEventAdd = function (e) {
        var r = this,
          n = this.getCurrentData().emitter;
        n.trigger("eventAdd", {
          event: e,
          relatedEvents: [],
          revert: function () {
            r.dispatch({ type: "REMOVE_EVENTS", eventStore: sa(e) });
          },
        });
      }),
      (t.prototype.getEventById = function (e) {
        ...
        for (var o in a) {
          var s = a[o];
          if (s.publicId === e) {
            if (s.recurringDef) return new N(r, s, null);
            for (var l in i) {
              var u = i[l];
              if (u.defId === s.defId) return new N(r, s, u);
            }
          }
        }
        return null;
      ...
      (t.prototype.getEventSources = function () {
        var e = this.getCurrentData(),
          r = e.eventSources,
          n = [];
        for (var a in r) n.push(new ve(e, r[a]));
        return n;
      }),
      (t.prototype.getEventSourceById = function (e) {
        var r = this.getCurrentData(),
          n = r.eventSources;
        e = String(e);
        for (var a in n) if (n[a].publicId === e) return new ve(r, n[a]);
        return null;
      }),
      (t.prototype.addEventSource = function (e) {
        ...
        if (e instanceof ve)
          return (
            r.eventSources[e.internalEventSource.sourceId] ||
              this.dispatch({
  ...
  N = (function () {
    ...
    return (
      (t.prototype.setProp = function (e, r) {
        var n, a;
        if (e in Zn)
          console.warn(
          ...
          (r = Ze[e](r)), this.mutate({ standardProps: { publicId: r } });
        else if (e in Ze)
          (r = Ze[e](r)),
            this.mutate({ standardProps: ((n = {}), (n[e] = r), n) });
        else if (e in at) {
          var i = at[e](r);
          e === "color"
            ? (i = { backgroundColor: r, borderColor: r })
            : e === "editable"
            ? (i = { startEditable: r, durationEditable: r })
            : (i = ((a = {}), (a[e] = r), a)),
      ...
      (t.prototype.setExtendedProp = function (e, r) {
        var n;
        this.mutate({ extendedProps: ((n = {}), (n[e] = r), n) });
      }),
      (t.prototype.setStart = function (e, r) {
        ...
        if (a && this._instance) {
          var i = this._instance.range,
            o = pe(i.start, a, n, r.granularity);
          r.maintainDuration
      ...
      (t.prototype.setDates = function (e, r, n) {
        n === void 0 && (n = {});
        var a = this._context.dateEnv,
          i = { allDay: n.allDay },
          o = a.createMarker(e),
          s;
        if (
          !!o &&
          !(r != null && ((s = a.createMarker(r)), !s)) &&
          this._instance
        ) {
          ...
          if (s) {
            ...
            fo(u, c)
              ? this.mutate({ datesDelta: u, standardProps: i })
              : this.mutate({ startDelta: u, endDelta: c, standardProps: i });
          } else
      ...
      (t.prototype.setAllDay = function (e, r) {
        r === void 0 && (r = {});
        var n = { allDay: e },
          a = r.maintainDuration;
        a == null && (a = this._context.options.allDayMaintainDuration),
          this._def.allDay !== e && (n.hasEnd = a),
      ...
      (t.prototype.formatRange = function (e) {
        ...
        return this._def.hasEnd
          ? r.formatRange(n.range.start, n.range.end, a, {
              forcedStartTzo: n.forcedStartTzo,
              forcedEndTzo: n.forcedEndTzo,
            })
          : r.format(n.range.start, a, { forcedTzo: n.forcedStartTzo });
      }),
      (t.prototype.mutate = function (e) {
        ...
        if (r) {
          ...
          (this._def = o.defs[n.defId]),
            (this._instance = o.instances[r.instanceId]),
            a.dispatch({ type: "MERGE_EVENTS", eventStore: o }),
            a.emitter.trigger("eventChange", {
              oldEvent: l,
              event: this,
              relatedEvents: oe(o, a, r),
              revert: function () {
                a.dispatch({ type: "RESET_EVENTS", eventStore: i });
              },
            });
        }
      }),
      ...
      (t.prototype.toPlainObject = function (e) {
        ...
        return (
          ...
          i && (s.start = i),
          o && (s.end = o),
          r.publicId && (s.id = r.publicId),
          r.groupId && (s.groupId = r.groupId),
          r.url && (s.url = r.url),
          n.display && n.display !== "auto" && (s.display = n.display),
          e.collapseColor &&
          n.backgroundColor &&
          ...
          Object.keys(r.extendedProps).length &&
            (e.collapseExtendedProps
              ? h(s, r.extendedProps)
              : (s.extendedProps = r.extendedProps)),
          s
        );
      }),
  ...
  if (e) {
    ...
    if (qn(r)) {
      ...
      return (
        ...
        { marker: r, isTimeUnspecified: !e[6], timeZoneOffset: n }
      );
    }
  }
  return null;
...
var Ss = (function () {
    function t(e) {
      var r = (this.timeZone = e.timeZone),
        n = r !== "local" && r !== "UTC";
      e.namedTimeZoneImpl &&
        n &&
        (this.namedTimeZoneImpl = new e.namedTimeZoneImpl(r)),
        (this.canComputeOffset = Boolean(!n || this.namedTimeZoneImpl)),
        (this.calendarSystem = gs(e.calendarSystem)),
    ...
    return (
      ...
      (t.prototype.createMarkerMeta = function (e) {
        ...
        return (
          typeof e == "number"
            ? (r = this.timestampToMarker(e))
            : e instanceof Date
            ? ((e = e.valueOf()), isNaN(e) || (r = this.timestampToMarker(e)))
            : Array.isArray(e) && (r = F(e)),
          r === null || !qn(r)
            ? null
            : { marker: r, isTimeUnspecified: !1, forcedTzo: null }
        );
      }),
      (t.prototype.parse = function (e) {
        ...
        var n = r.marker,
          a = null;
        return (
          r.timeZoneOffset !== null &&
            (this.canComputeOffset
              ? (n = this.timestampToMarker(
                  n.valueOf() - r.timeZoneOffset * 60 * 1e3
                ))
              : (a = r.timeZoneOffset)),
          { marker: n, isTimeUnspecified: r.isTimeUnspecified, forcedTzo: a }
        );
      }),
      ...
      (t.prototype.diffWholeYears = function (e, r) {
        ...
        return Q(e) === Q(r) &&
          n.getMarkerDay(e) === n.getMarkerDay(r) &&
          n.getMarkerMonth(e) === n.getMarkerMonth(r)
          ? n.getMarkerYear(r) - n.getMarkerYear(e)
          : null;
      }),
      (t.prototype.diffWholeMonths = function (e, r) {
        var n = this.calendarSystem;
        return Q(e) === Q(r) && n.getMarkerDay(e) === n.getMarkerDay(r)
          ? n.getMarkerMonth(r) -
              n.getMarkerMonth(e) +
              (n.getMarkerYear(r) - n.getMarkerYear(e)) * 12
          : null;
      }),
                            ...
                            Dt(n)
                              ...
                              : ((n = Ki(e, r)),
                                Dt(n)
                                  ...
                                  : {
                                      unit: "millisecond",
                                      value: r.valueOf() - e.valueOf(),
                                    }))))));
      }),
      (t.prototype.countDurationsBetween = function (e, r, n) {
        var a;
        return n.years && ((a = this.diffWholeYears(e, r)), a !== null)
          ? a / po(n)
          : n.months && ((a = this.diffWholeMonths(e, r)), a !== null)
          ? a / ho(n)
          : n.days && ((a = Qe(e, r)), a !== null)
          ? a / he(n)
          : (r.valueOf() - e.valueOf()) / xe(n);
      }),
      ...
      (t.prototype.computeWeekNumber = function (e) {
        return this.weekNumberFunc
          ...
          : no(e, this.weekDow, this.weekDoy);
      }),
      (t.prototype.format = function (e, r, n) {
        return (
          n === void 0 && (n = {}),
          r.format(
            {
              marker: e,
              timeZoneOffset:
                n.forcedTzo != null ? n.forcedTzo : this.offsetForMarker(e),
            },
            this
          )
        );
      ...
      (t.prototype.formatRange = function (e, r, n, a) {
        return (
          a === void 0 && (a = {}),
          a.isEndExclusive && (r = le(r, -1)),
          n.formatRange(
            {
              marker: e,
              timeZoneOffset:
                a.forcedStartTzo != null
                  ? a.forcedStartTzo
      ...
      (t.prototype.formatIso = function (e, r) {
        ...
        var n = null;
        return (
          r.omitTimeZoneOffset ||
            (r.forcedTzo != null
              ? (n = r.forcedTzo)
              : (n = this.offsetForMarker(e))),
          go(e, n, r.omitTime)
        );
      }),
      (t.prototype.timestampToMarker = function (e) {
        return this.timeZone === "local"
          ...
          ? new Date(e)
          : F(this.namedTimeZoneImpl.timestampToArray(e));
      }),
      (t.prototype.offsetForMarker = function (e) {
        return this.timeZone === "local"
          ? -jr(J(e)).getTimezoneOffset()
          : this.timeZone === "UTC"
          ? 0
          : this.namedTimeZoneImpl
          ? this.namedTimeZoneImpl.offsetForArray(J(e))
          : null;
      }),
      (t.prototype.toDate = function (e, r) {
        return this.timeZone === "local"
          ...
          ? new Date(
              e.valueOf() -
                this.namedTimeZoneImpl.offsetForArray(J(e)) * 1e3 * 60
            )
          : new Date(e.valueOf() - (r || 0));
      }),
      t
    );
  })(),
...
function Rs(t, e) {
  for (var r = 0; r < t.length; r += 1)
    for (
      var n = t[r].toLocaleLowerCase().split("-"), a = n.length;
      a > 0;
      a -= 1
    ) {
...
function ur(t, e) {
  var r = ["fc-day", "fc-day-" + ji[t.dow]];
  return (
    t.isDisabled
      ? r.push("fc-day-disabled")
      : (t.isToday && (r.push("fc-day-today"), r.push(e.getClass("today"))),
        t.isPast && r.push("fc-day-past"),
        t.isFuture && r.push("fc-day-future"),
        t.isOther && r.push("fc-day-other")),
    r
  );
}
var xs = V({ year: "numeric", month: "long", day: "numeric" }),
  As = V({ week: "long" });
function cr(t, e, r, n) {
      ...
      u = function (c) {
        var d =
          r === "day"
            ...
            : null;
        typeof d == "function"
          ? d.call(o, a.toDate(e), c)
          : (typeof d == "string" && (r = d), o.zoomTo(e, r));
      };
    return h(
      { title: Me(i.navLinkHint, [s, l], s), "data-navlink": "" },
      n ? zn(u) : { onClick: u }
    );
  }
  return { "aria-label": s };
...
function Os() {
  ...
  _e(t, {
    ...
    document.body.appendChild(t);
  var e = t.firstChild,
    r = e.getBoundingClientRect().left > t.getBoundingClientRect().left;
  return Xt(t), r;
}
var Mt;
function Ls() {
...
function Us(t, e) {
  ...
  var r = window.getComputedStyle(t),
    ...
    a = parseInt(r.borderRightWidth, 10) || 0,
    i = parseInt(r.borderTopWidth, 10) || 0,
...
function Ws(t, e, r) {
  e === void 0 && (e = !1);
  var n = r ? t.getBoundingClientRect() : dr(t),
    a = Us(t, e),
    i = {
  ...
  return (
    e &&
      ((i.left += a.paddingLeft),
      (i.right -= a.paddingRight),
      (i.top += a.paddingTop),
      (i.bottom -= a.paddingBottom)),
    i
  );
}
function dr(t) {
...
function Bs(t) {
  for (
    var e = ma(t), r = t.getBoundingClientRect(), n = 0, a = e;
    n < a.length;
    n++
  ) {
    var i = a[n],
      o = va(r, i.getBoundingClientRect());
    if (o) r = o;
    else return null;
  }
  return r;
...
function ma(t) {
  for (var e = []; t instanceof HTMLElement; ) {
    var r = window.getComputedStyle(t);
    if (r.position === "fixed") break;
    /(auto|scroll)/.test(r.overflow + r.overflowY + r.overflowX) && e.push(t),
      (t = t.parentNode);
  }
  return e;
}
    ...
    return (
      ...
      (t.prototype.leftToIndex = function (e) {
        var r = this,
          ...
          i = n.length,
          o;
        for (o = 0; o < i; o += 1) if (e >= n[o] && e < a[o]) return o;
      }),
    ...
    return (
      (t.prototype.setIconOverride = function (e) {
        ...
        if (typeof e == "object" && e) {
          ...
          for (n in e) r[n] = this.applyIconOverridePrefix(e[n]);
          this.iconClasses = r;
      ...
      (t.prototype.getIconClass = function (e, r) {
        var n;
        return (
          r && this.rtlIconClasses
            ? (n = this.rtlIconClasses[e] || this.iconClasses[e])
            : (n = this.iconClasses[e]),
      ...
      (t.prototype.getCustomButtonIconClass = function (e) {
        ...
        return this.iconOverrideCustomButtonOption &&
          ((r = e[this.iconOverrideCustomButtonOption]), r)
          ? this.baseIconClass + " " + this.applyIconOverridePrefix(r)
          : "";
      }),
      t
    );
...
var js = (function () {
    function t(e, r, n, a) {
      ...
      (this.execFunc = e),
        (this.emitter = r),
        (this.scrollTime = n),
        (this.scrollTimeReset = a),
        (this.handleScrollRequest = function (o) {
          (i.queuedRequest = h({}, i.queuedRequest || {}, o)), i.drain();
        }),
        r.on("_scrollRequest", this.handleScrollRequest),
  ...
  de = Vn({});
function Zs(t, e, r, n, a, i, o, s, l, u, c, d, f) {
  return {
    dateEnv: a,
    options: r,
    pluginHooks: o,
    ...
    createScrollResponder: function (v) {
      return new js(v, u, I(r.scrollTime), r.scrollTimeReset);
    },
...
var pt = (function (t) {
  ...
  return (
    (e.prototype.shouldComponentUpdate = function (r, n) {
      return (
        this.debug && console.log(Zr(r, this.props), Zr(n, this.state)),
        !Rt(this.props, r, this.propEquality) ||
          !Rt(this.state, n, this.stateEquality)
      );
    }),
    (e.prototype.safeSetState = function (r) {
      Rt(this.state, h(h({}, this.state), r), this.stateEquality) ||
        this.setState(r);
    }),
    (e.addPropsEquality = Xs),
    (e.addStateEquality = $s),
    (e.contextType = de),
    e
  );
})(Zt);
...
function Ks(t, e) {
  ...
  function a(i) {
    for (var o = 0, s = i; o < s.length; o++) {
      var l = s[o];
      r[l.id] || ((r[l.id] = !0), a(l.deps), (n = Qs(n, l)));
    }
  }
  return t && a(t), a(e), n;
}
function Js() {
  ...
  return function (n, a) {
    return (
      (!r || !Ee(n, t) || !Ee(a, e)) && (r = Ks(n, a)), (t = n), (e = a), r
    );
  };
}
function Qs(t, e) {
  return {
    ...
    optionChangeHandlers: h(
      h({}, t.optionChangeHandlers),
...
function el(t, e) {
  var r = {},
    n;
  for (n in t) Ft(n, r, t, e);
  for (n in e) Ft(n, r, t, e);
  return r;
}
function Ft(t, e, r, n) {
  if (e[t]) return e[t];
...
var Re = (function (t) {
        ...
        return m(
          ...
          function (i) {
            return m(
              ...
              function (o, s) {
                return n.children(i, ba(n.classNames, a), o, s);
              }
            );
          }
        );
  ...
  ya = Vn(0);
function Ea(t) {
  return m(ya.Consumer, null, function (e) {
    return m(rl, h({ renderId: e }, t));
  });
}
var rl = (function (t) {
    R(e, t);
    ...
    return (
      ...
      (e.prototype.renderInnerContent = function () {
        var r = this.customContentInfo,
          n = this.getInnerContent(),
          a = this.getContentMeta(n);
        return (
          !r || r.contentKey !== a.contentKey
            ? (r &&
                (r.destroy && r.destroy(), (r = this.customContentInfo = null)),
              a.contentKey &&
                (r = this.customContentInfo =
                  h(
                    { contentKey: a.contentKey, contentVal: n[a.contentKey] },
                    a.buildLifecycleFuncs()
                  )))
            : r && (r.contentVal = n[a.contentKey]),
          r ? [] : n
        );
      }),
      (e.prototype.getInnerContent = function () {
        var r = this.props,
          n = sn(r.content, r.hookProps);
        return (
          n === void 0 && (n = sn(r.defaultContent, r.hookProps)),
          n == null ? null : n
        );
      }),
      (e.prototype.getContentMeta = function (r) {
        var n = this.context.pluginHooks.contentTypeHandlers,
          a = "",
          i = null;
        if (r) {
          for (var o in n)
...
function Sa() {
  var t,
    ...
    r = [];
  return function (n, a) {
    return (!e || !X(e, a) || n !== t) && ((t = n), (e = a), (r = ba(n, a))), r;
  };
}
function ba(t, e) {
...
var zt = (function (t) {
  ...
  function e() {
    var r = (t !== null && t.apply(this, arguments)) || this;
    return (r.normalizeClassNames = Sa()), r;
  }
  return (
    (e.prototype.render = function () {
      var r = this,
        ...
        i = a.options,
        o = { view: a.viewApi },
        s = this.normalizeClassNames(i.viewClassNames, o);
      return m(
        vr,
        {
          hookProps: o,
        ...
        function (l) {
          return n.children(
            l,
            ["fc-" + n.viewSpec.type + "-view", "fc-view"].concat(s)
          );
        }
      );
    }),
...
function nl(t) {
  var e = typeof t == "function" ? { component: t } : t,
    r = e.component;
  return (
    e.content && (r = al(e)), { superType: e.type, component: r, rawOptions: e }
  );
}
function al(t) {
  return function (e) {
...
function ol(t, e, r, n, a) {
  var i =
      t.overrides.duration || t.defaults.duration || n.duration || r.duration,
    o = null,
    s = "",
    l = "",
    u = {};
  ...
  return {
    ...
    buttonTextOverride: d(n) || d(r) || t.overrides.buttonText,
    buttonTextDefault: d(a) || t.defaults.buttonText || d(ke) || t.type,
    buttonTitleOverride: f(n) || f(r) || t.overrides.buttonHint,
    buttonTitleDefault: f(a) || t.defaults.buttonHint || f(ke),
  };
}
var un = {};
function sl(t) {
...
var Da = (function () {
  function t(e) {
    (this.props = e),
      (this.nowDate = Ne(e.nowInput, e.dateEnv)),
      this.initHiddenDays();
  }
  return (
    (t.prototype.buildPrev = function (e, r, n) {
      var a = this.props.dateEnv,
        i = a.subtract(a.startOf(r, e.currentRangeUnit), e.dateIncrement);
      return this.build(i, -1, n);
    }),
    (t.prototype.buildNext = function (e, r, n) {
      var a = this.props.dateEnv,
        i = a.add(a.startOf(r, e.currentRangeUnit), e.dateIncrement);
      return this.build(i, 1, n);
    }),
    (t.prototype.build = function (e, r, n) {
      ...
      return (
        ...
        n && (e = qo(e, i)),
        (o = this.buildCurrentRangeInfo(e, r)),
        (s = /^(year|month|week|day)$/.test(o.unit)),
        (l = this.buildRenderRange(this.trimHiddenDays(o.range), o.unit, s)),
        (l = this.trimHiddenDays(l)),
        (u = l),
        a.showNonCurrentDates || (u = Ae(u, o.range)),
    ...
    (t.prototype.buildCurrentRangeInfo = function (e, r) {
      ...
      return (
        n.duration
          ? ((a = n.duration),
            (i = n.durationUnit),
            (o = this.buildRangeFromDuration(e, r, a, i)))
          : (s = this.props.dayCount)
          ? ((i = "day"), (o = this.buildRangeFromDayCount(e, r, s)))
          : (o = this.buildCustomVisibleRange(e))
          ? (i = n.dateEnv.greatestWholeUnit(o.start, o.end).unit)
          : ((a = this.getFallbackDuration()),
            (i = Lt(a).unit),
            (o = this.buildRangeFromDuration(e, r, a, i))),
        { duration: a, unit: i, range: o }
      );
    }),
    ...
    (t.prototype.adjustActiveRange = function (e) {
      ...
      return (
        a &&
          (he(i) < 0 && ((s = H(s)), (s = n.add(s, i))),
          he(o) > 1 && ((l = H(l)), (l = W(l, -1)), (l = n.add(l, o)))),
        { start: s, end: l }
      );
    }),
    (t.prototype.buildRangeFromDuration = function (e, r, n, a) {
      ...
      if (!s) {
        ...
        d && xe(d) < xe(n) ? (s = Lt(d).unit) : (s = a);
      }
      he(n) <= 1 &&
        this.isHiddenDay(l) &&
        ((l = this.skipHiddenDays(l, r)), (l = H(l)));
      function f() {
        (l = o.startOf(e, s)), (u = o.add(l, n)), (c = { start: l, end: u });
      }
      return (
        f(), this.trimHiddenDays(c) || ((e = this.skipHiddenDays(e, r)), f()), c
      );
    }),
    (t.prototype.buildRangeFromDayCount = function (e, r, n) {
      ...
      o && (l = i.startOf(l, o)),
        (l = H(l)),
        (l = this.skipHiddenDays(l, r)),
        (u = l);
      do (u = W(u, 1)), this.isHiddenDay(u) || (s += 1);
      while (s < n);
      return { start: l, end: u };
    }),
    (t.prototype.buildCustomVisibleRange = function (e) {
      var r = this.props,
        n = r.visibleRangeInput,
        a =
          typeof n == "function"
            ? n.call(r.calendarApi, r.dateEnv.toDate(e))
            : n,
        i = this.refineRange(a);
    ...
    (t.prototype.buildDateIncrement = function (e) {
      var r = this.props.dateIncrement,
        n;
      return (
        r || ((n = this.props.dateAlignment) ? I(1, n) : e || I({ days: 1 }))
      );
    }),
    (t.prototype.refineRange = function (e) {
      if (e) {
        var r = Fo(e, this.props.dateEnv);
        return r && (r = Jn(r)), r;
      }
      return null;
    }),
    (t.prototype.initHiddenDays = function () {
      var e = this.props.hiddenDays || [],
        r = [],
        n = 0,
        a;
    ...
    (t.prototype.trimHiddenDays = function (e) {
      var r = e.start,
        n = e.end;
      return (
        r && (r = this.skipHiddenDays(r)),
        n && (n = this.skipHiddenDays(n, -1, !0)),
        r == null || n == null || r < n ? { start: r, end: n } : null
      );
    }),
    ...
    (t.prototype.skipHiddenDays = function (e, r, n) {
      for (
        ...
        this.isHiddenDayHash[(e.getUTCDay() + (n ? r : 0) + 7) % 7];
...
function cl(t, e, r, n) {
  ...
  switch (e.type) {
    ...
    case "PREV":
      if (((a = n.buildPrev(t, r)), a.isValid)) return a;
      break;
    case "NEXT":
      if (((a = n.buildNext(t, r)), a.isValid)) return a;
      break;
  }
  return t;
}
function dl(t, e, r) {
  ...
  return Ra({}, yl(t, r), n, r);
}
function fl(t, e, r, n) {
  var a = r ? r.activeRange : null;
  switch (e.type) {
    case "ADD_EVENT_SOURCES":
      return Ra(t, e.sources, a, n);
    case "REMOVE_EVENT_SOURCE":
      return pl(t, e.sourceId);
    case "PREV":
    case "NEXT":
    case "CHANGE_DATE":
    case "CHANGE_VIEW_TYPE":
    ...
    case "FETCH_EVENT_SOURCES":
      return pr(
        t,
        e.sourceIds ? Yn(e.sourceIds) : Ta(t, n),
        a,
        e.isRefetch || !1,
        n
      );
    ...
    case "RECEIVE_EVENT_ERROR":
      return ml(t, e.sourceId, e.fetchId, e.fetchRange);
...
function gl(t, e, r, n) {
  var a = n.options,
    i = n.calendarApi,
    o = n.pluginHooks.eventSourceDefs[t.sourceDefId],
    s = be();
  return (
    o.fetch(
      { eventSource: t, range: e, isRefetch: r, context: n },
      function (l) {
        var u = l.rawEvents;
        a.eventSourceSuccess &&
          (u = a.eventSourceSuccess.call(i, u, l.xhr) || u),
          t.success && (u = t.success.call(i, u, l.xhr) || u),
          n.dispatch({
            type: "RECEIVE_EVENTS",
            sourceId: t.sourceId,
            fetchId: s,
      ...
      function (l) {
        console.warn(l.message, l),
          a.eventSourceFailure && a.eventSourceFailure.call(i, l),
...
function ml(t, e, r, n) {
  var a,
    i = t[e];
  return i && r === i.latestFetchId
    ? h(
        h({}, t),
        ((a = {}), (a[e] = h(h({}, i), { isFetching: !1, fetchRange: n })), a)
      )
    : t;
}
function Ta(t, e) {
...
function yl(t, e) {
  var r = oa(e),
    n = [].concat(t.eventSources || []),
    a = [];
  t.initialEvents && n.unshift(t.initialEvents),
    t.events && n.unshift(t.events);
...
function El(t, e, r, n, a) {
  switch (e.type) {
    case "RECEIVE_EVENTS":
      return Sl(t, r[e.sourceId], e.fetchId, e.fetchRange, e.rawEvents, a);
    case "ADD_EVENTS":
      return Dl(t, e.eventStore, n ? n.activeRange : null, a);
    case "RESET_EVENTS":
      return e.eventStore;
    case "MERGE_EVENTS":
    ...
    case "REMOVE_EVENTS":
      return Ao(t, e.eventStore);
    case "REMOVE_EVENT_SOURCE":
      return Ma(t, e.sourceId);
    case "REMOVE_ALL_EVENT_SOURCES":
...
function Sl(t, e, r, n, a, i) {
  if (e && r === e.latestFetchId) {
    var o = nt(bl(a, e, i), e, i);
    return n && (o = ye(o, n, i)), ar(Ma(t, e.sourceId), o);
  }
  return t;
}
function bl(t, e, r) {
  var n = r.options.eventDataTransform,
    a = e ? e.eventDataTransform : null;
    ...
    a = ce(t.instances, function (i) {
      ...
      return o.allDay || o.recurringDef
        ...
        : h(h({}, i), {
            ...
            forcedStartTzo: r.canComputeOffset ? null : i.forcedStartTzo,
            forcedEndTzo: r.canComputeOffset ? null : i.forcedEndTzo,
          });
    });
...
function kl(t, e, r, n, a) {
  var i = t.headerToolbar ? dn(t.headerToolbar, t, e, r, n, a) : null,
    o = t.footerToolbar ? dn(t.footerToolbar, t, e, r, n, a) : null;
  ...
  var o = e.direction === "rtl",
    ...
    E = f.map(function (S) {
      return S.split(",").map(function (g) {
        if (g === "title") return (p = !0), { buttonName: g };
        var b, D, C, k, T, P;
        if ((b = s[g]))
          (C = function (L) {
            b.click && b.click.call(L.target, L, L.target);
          }),
            (k = n.getCustomButtonIconClass(b)) ||
              (k = n.getIconClass(g, o)) ||
              (T = b.text),
            (P = b.hint || b.text);
        else if ((D = a[g])) {
          v.push(g),
          ...
          if (
            ...
            (T = l[g]) || (k = n.getIconClass(g, o)) || (T = u[g]),
            g === "prevYear" || g === "nextYear")
          ) {
            var O = g === "prevYear" ? "prev" : "next";
            P = Me(c[O] || d[O], [u.year || "year", "year"], u[g]);
          } else
            P = function (L) {
              return Me(c[g] || d[g], [u[L] || L, L], u[g]);
            };
        return {
          buttonName: g,
          buttonClick: C,
...
var Pl = {
  ...
  Hl = te({ eventSourceDefs: [Pl] }),
  xl = {
    parseMeta: function (t) {
      return typeof t.events == "function" ? t.events : null;
    },
    fetch: function (t, e, r) {
      var n = t.context.dateEnv,
        a = t.eventSource.meta;
      Fs(
        a.bind(null, ra(t.range, n)),
        function (i) {
          e({ rawEvents: i });
        },
        r
  ...
  Al = te({ eventSourceDefs: [xl] });
function Nl(t, e, r, n, a) {
  t = t.toUpperCase();
  var i = null;
  t === "GET" ? (e = Ol(e, r)) : (i = ka(r));
...
var Ll = {
  ...
  Vl = {
    ...
    fetch: function (t, e, r) {
      var n = t.eventSource.meta,
        a = Wl(n, t.range, t.context);
      Nl(
        n.method,
        n.url,
        a,
  ...
  Ul = te({ eventSourceRefiners: Ll, eventSourceDefs: [Vl] });
function Wl(t, e, r) {
  var n = r.dateEnv,
    a = r.options,
    i,
  ...
  return (
    (i = t.startParam),
    i == null && (i = a.startParam),
    (o = t.endParam),
    o == null && (o = a.endParam),
    (s = t.timeZoneParam),
    s == null && (s = a.timeZoneParam),
    typeof t.extraParams == "function"
      ? (l = t.extraParams())
      : (l = t.extraParams || {}),
    h(u, l),
    (u[i] = n.formatIso(e.start)),
    (u[o] = n.formatIso(e.end)),
    n.timeZone !== "local" && (u[s] = n.timeZone),
    u
  );
}
var Bl = {
  ...
  Fl = {
    parse: function (t, e) {
      if (
        ...
        var r = {
          ...
          n = void 0;
        return (
          t.duration && (n = t.duration),
          !n && t.startTime && t.endTime && (n = vo(t.endTime, t.startTime)),
          {
    ...
    expand: function (t, e, r) {
      ...
      return n ? Gl(t.daysOfWeek, t.startTime, n, r) : [];
    },
  },
  zl = te({ recurringTypes: [Fl], eventRefiners: Bl });
function Gl(t, e, r, n) {
  for (var a = t ? Yn(t) : null, i = H(r.start), o = r.end, s = []; i < o; ) {
    var l = void 0;
    (!a || a[i.getUTCDay()]) && (e ? (l = n.add(i, e)) : (l = i), s.push(l)),
      (i = W(i, 1));
  }
  return s;
}
...
function fn(t, e) {
  for (
    var r = er(e.getCurrentData().eventSources), n = [], a = 0, i = t;
    a < i.length;
    a++
  ) {
  ...
  for (var u = 0, c = r; u < c.length; u++) {
    var d = c[u];
    e.dispatch({ type: "REMOVE_EVENT_SOURCE", sourceId: d.sourceId });
  }
...
function Yl(t, e) {
  e.emitter.trigger(
    "datesSet",
    h(h({}, ra(t.activeRange, e.dateEnv)), { view: e.viewApi })
  );
}
function jl(t, e) {
  var r = e.emitter;
...
var Zl = [
  ...
  te({
    isLoadingFuncs: [
      function (t) {
        return Ca(t.eventSources);
      },
    ],
    contentTypeHandlers: { html: Xl, domNodes: $l },
    propSetHandlers: { dateProfile: Yl, eventStore: jl },
  }),
];
function Xl() {
  var t = null,
  ...
  Kl = (function () {
    function t(e, r) {
      (this.runTaskOption = e),
        (this.drainedOption = r),
        (this.queue = []),
        (this.delayedRunner = new hr(this.drain.bind(this)));
    }
    return (
...
function Jl(t, e, r) {
  ...
  return (
    /^(year|month)$/.test(t.currentRangeUnit)
      ? (n = t.currentRange)
      : (n = t.activeRange),
    r.formatRange(n.start, n.end, V(e.titleFormat || Ql(t)), {
...
var Ia = (function () {
  function t(e) {
    var r = this;
    (this.computeOptionsData = M(this._computeOptionsData)),
      (this.computeCurrentViewData = M(this._computeCurrentViewData)),
      (this.organizeRawLocales = M(Ds)),
      (this.buildLocale = M(da)),
      (this.buildPluginHooks = Js()),
      (this.buildDateEnv = M(eu)),
      (this.buildTheme = M(tu)),
      (this.parseToolbars = M(kl)),
      (this.buildViewSpecs = M(il)),
      (this.buildDateProfileGenerator = je(ru)),
      (this.buildViewApi = M(nu)),
      (this.buildViewUiProps = je(ou)),
      (this.buildEventUiBySource = M(au, X)),
      (this.buildEventUiBases = M(iu)),
      (this.parseContextBusinessHours = je(su)),
      (this.buildTitle = M(Jl)),
      (this.emitter = new vt()),
      (this.actionRunner = new Kl(
    ...
    var n = {},
      a = this.computeOptionsData(e.optionOverrides, n, e.calendarApi),
      i = a.calendarOptions.initialView || a.pluginHooks.initialView,
      o = this.computeCurrentViewData(i, a, e.optionOverrides, n);
    (e.calendarApi.currentDataManager = this),
      this.emitter.setThisContext(e.calendarApi),
      this.emitter.setOptions(o.options);
    var s = vs(a.calendarOptions, a.dateEnv),
      l = o.dateProfileGenerator.build(s);
    ...
    for (
      var v = dl(a.calendarOptions, l, u),
        p = {
    ...
    kt(p, u) && this.emitter.trigger("loading", !0),
      (this.state = p),
      this.updateData(),
      this.actionRunner.resume();
  }
  return (
    (t.prototype.resetOptions = function (e, r) {
      var n = this.props;
      (n.optionOverrides = r ? h(h({}, n.optionOverrides), e) : e),
    ...
    (t.prototype._handleAction = function (e) {
      var r = this,
        ...
        a = r.state,
        i = r.emitter,
        o = ul(a.dynamicOptionOverrides, e),
        s = this.computeOptionsData(n.optionOverrides, o, n.calendarApi),
        l = ll(a.currentViewType, e),
        u = this.computeCurrentViewData(l, s, n.optionOverrides, o);
      ...
      this.data &&
        ...
        (f = u.dateProfileGenerator.build(d)),
        (d = fs(d, e)),
        (f = cl(f, e, d, u.dateProfileGenerator)),
        (e.type === "PREV" || e.type === "NEXT" || !ie(f.currentRange, d)) &&
          (d = f.currentRange.start);
      for (
        var v = fl(a.eventSources, e, f, c),
          p = El(a.eventStore, e, v, f, c),
          E = Ca(v),
          S =
            (E &&
          ...
          b = g.eventUiSingleBase,
          D = g.selectionConfig,
          C = this.buildEventUiBySource(v),
          k = this.buildEventUiBases(S.defs, b, C),
          T = {
            ...
            dateSelection: wl(a.dateSelection, e),
            eventSelection: Tl(a.eventSelection, e),
            eventDrag: _l(a.eventDrag, e),
            eventResize: Ml(a.eventResize, e),
          },
          P = h(h({}, c), T),
          _ = 0,
          O = s.pluginHooks.reducers;
        _ < O.length;
        _++
      ) {
        var L = O[_];
      ...
      var Z = kt(a, c),
        z = kt(T, c);
      !Z && z ? i.trigger("loading", !0) : Z && !z && i.trigger("loading", !1),
        (this.state = T),
    ...
    (t.prototype.updateData = function () {
      var e = this,
        ...
        u = a && a.calendarOptions,
        c = i.calendarOptions;
      if (u && u !== c) {
        u.timeZone !== c.timeZone &&
          ((n.eventSources = s.eventSources =
            vl(s.eventSources, n.dateProfile, s)),
          (n.eventStore = s.eventStore =
            Cl(s.eventStore, a.dateEnv, s.dateEnv)));
        for (var d in l) u[d] !== c[d] && l[d](c[d], s);
      }
      r.onData && r.onData(s);
    }),
    (t.prototype._computeOptionsData = function (e, r, n) {
      var a = this.processRawCalendarOptions(e, r),
        i = a.refinedOptions,
        o = a.pluginHooks,
        s = a.localeDefaults,
        l = a.availableLocaleData,
        u = a.extra;
      vn(u);
      var c = this.buildDateEnv(
          i.timeZone,
          i.locale,
        ...
        d = this.buildViewSpecs(o.views, e, r, s),
        f = this.buildTheme(i, o),
        v = this.parseToolbars(i, e, f, d, n);
      return {
        calendarOptions: i,
        pluginHooks: o,
        dateEnv: c,
    ...
    (t.prototype.processRawCalendarOptions = function (e, r) {
      var n = wt([ke, e, r]),
        a = n.locales,
        i = n.locale,
        o = this.organizeRawLocales(a),
        s = o.map,
        l = this.buildLocale(i || o.defaultCode, s).options,
        u = this.buildPluginHooks(e.plugins || [], Zl),
        c = (this.currentCalendarOptionsRefiners = h(
          h(h(h(h({}, Qr), en), tn), u.listenerRefiners),
          u.optionRefiners
        )),
        d = {},
        f = wt([ke, l, e, r]),
        ...
        E = this.currentCalendarOptionsRefined,
        S = !1;
      for (var g in f)
        g !== "plugins" &&
          (f[g] === p[g] || (ne[g] && g in p && ne[g](p[g], f[g]))
            ? (v[g] = E[g])
            : c[g]
            ? ((v[g] = c[g](f[g])), (S = !0))
            : (d[g] = p[g]));
    ...
    (t.prototype._computeCurrentViewData = function (e, r, n, a) {
      ...
      var o = this.processRawViewOptions(
          i,
          r.pluginHooks,
          r.localeDefaults,
          n,
    ...
    (t.prototype.processRawViewOptions = function (e, r, n, a, i) {
      var o = wt([ke, e.optionDefaults, n, a, e.optionOverrides, i]),
        s = h(
          h(h(h(h(h({}, Qr), en), tn), Ho), r.listenerRefiners),
          r.optionRefiners
        ),
        l = {},
        ...
        f = {};
      for (var v in o)
        o[v] === u[v] || (ne[v] && ne[v](o[v], u[v]))
          ? (l[v] = c[v])
          : (o[v] === this.currentCalendarOptionsInput[v] ||
            (ne[v] && ne[v](o[v], this.currentCalendarOptionsInput[v]))
              ? v in this.currentCalendarOptionsRefined &&
                (l[v] = this.currentCalendarOptionsRefined[v])
              : s[v]
              ? (l[v] = s[v](o[v]))
              : (f[v] = o[v]),
            (d = !0));
...
function eu(t, e, r, n, a, i, o, s) {
  var l = da(e || o.defaultCode, o.map);
  return new Ss({
...
function ru(t) {
  var e = t.dateProfileGeneratorClass || Da;
  return new e(t);
}
function nu(t, e, r) {
  return new us(t, e, r);
...
function su(t) {
  return Ts(t.options.businessHours, t);
}
function vn(t, e) {
  for (var r in t)
    console.warn(
      "Unknown option '" + r + "'" + (e ? " for view '" + e + "'" : "")
    );
}
(function (t) {
  R(e, t);
  function e(r) {
    ...
    return (
      (n.handleData = function (a) {
        n.dataManager ? n.setState(a) : (n.state = a);
      }),
      (n.dataManager = new Ia({
  ...
  return (
    ...
    (t.prototype.insertEntry = function (e, r) {
      ...
      return this.isInsertionValid(n, e)
        ...
        : this.handleInvalidInsertion(n, e, r);
    }),
    (t.prototype.isInsertionValid = function (e, r) {
      return (
        (this.maxCoord === -1 || e.levelCoord + r.thickness <= this.maxCoord) &&
    ...
    (t.prototype.handleInvalidInsertion = function (e, r, n) {
      return this.allowReslicing && e.touchingEntry
        ? this.splitEntry(r, e.touchingEntry, n)
        : (n.push(r), 0);
    }),
    (t.prototype.splitEntry = function (e, r, n) {
      ...
      return (
        ...
        a
          ? (n.push.apply(
              n,
              A([{ index: e.index, thickness: e.thickness, span: Pa(s, o) }], i)
            ),
            a)
          : (n.push(e), 0)
      );
    ...
    (t.prototype.insertEntryAt = function (e, r) {
      var n = this,
        ...
        i = n.levelCoords;
      r.lateral === -1
        ? (It(i, r.level, r.levelCoord), It(a, r.level, [e]))
        : It(a[r.level], r.lateral, e),
        (this.stackCnts[Pe(e)] = r.stackCnt);
    }),
    (t.prototype.findInsertion = function (e) {
      for (
        ...
        var p = n[v];
        if (!i && p >= l + e.thickness) break;
        for (
          var E = a[v],
            S = void 0,
            g = hn(E, e.span.start, pn),
            b = g[0] + g[1];
          (S = E[b]) && S.span.start < e.span.end;

        ) {
          var D = p + S.thickness;
          D > l && ((l = D), (d = S), (u = v), (c = b)),
            D === l && (f = Math.max(f, o[Pe(S)] + 1)),
            (b += 1);
        }
      }
      var C = 0;
      if (d) for (C = u + 1; C < s && n[C] < l; ) C += 1;
      var k = -1;
      return (
        C < s && n[C] === l && (k = hn(a[C], e.span.end, pn)[0]),
        {
          touchingLevel: u,
          touchingLateral: c,
          touchingEntry: d,
...
function Pa(t, e) {
  var r = Math.max(t.start, e.start),
    n = Math.min(t.end, e.end);
...
function hn(t, e, r) {
  var n = 0,
    a = t.length;
  if (!a || e < r(t[n])) return [0, 0];
  if (e > r(t[a - 1])) return [a, 0];
  for (; n < a; ) {
...
var Gt = {},
  ...
  cu = (function (t) {
    ...
    return (
      (e.prototype.render = function () {
        var r = this,
          n = this.props.widgetGroups.map(function (a) {
            return r.renderWidgetGroup(a);
          });
        return m.apply(
          void 0,
          A(["div", { className: "fc-toolbar-chunk" }], n)
        );
      }),
      (e.prototype.renderWidgetGroup = function (r) {
        for (
          var n = this.props,
            a = this.context.theme,
            i = [],
            o = !0,
            s = 0,
            l = r;
          ...
          if (c === "title")
            (o = !1),
              i.push(
                m(
                  "h2",
                  { className: "fc-toolbar-title", id: n.titleId },
                  n.title
                )
              );
          else {
            var E = c === n.activeButton,
              S =
                (!n.isTodayEnabled && c === "today") ||
                (!n.isPrevEnabled && c === "prev") ||
                (!n.isNextEnabled && c === "next"),
              g = ["fc-" + c + "-button", a.getClass("button")];
            E && g.push(a.getClass("buttonActive")),
              i.push(
                m(
                  "button",
                  {
                    type: "button",
                    title: typeof p == "function" ? p(n.navUnit) : p,
                    disabled: S,
                    "aria-pressed": E,
                    className: g.join(" "),
                    onClick: d,
                  },
                  f || (v ? m("span", { className: v }) : "")
                )
              );
          }
        }
    ...
    return (
      (e.prototype.render = function () {
        var r = this.props,
          ...
          l = n.sectionWidgets,
          u = l.center;
        l.left ? ((i = !0), (o = l.left)) : (o = l.start),
          l.right ? ((i = !0), (s = l.right)) : (s = l.end);
        var c = [a || "", "fc-toolbar", i ? "fc-toolbar-ltr" : ""];
        return m(
          "div",
          { className: c.join(" ") },
  ...
  du = (function (t) {
    ...
    return (
      (e.prototype.render = function () {
        ...
        return (
          i
            ? a.availableWidth !== null
              ? (s = a.availableWidth / i)
              : (l = (1 / i) * 100 + "%")
            : (s = n.height || ""),
          m(
            "div",
            {
              "aria-labelledby": n.labeledById,
              ref: this.handleEl,
              className: o.join(" "),
  ...
  fu = (function (t) {
    ...
    function e(r) {
      var n = t.call(this, r) || this;
      return (
        (n.handleSegClick = function (a, i) {
          var o = n.component,
            s = o.context,
            l = Se(i);
          if (l && o.isValidSegDownEl(a.target)) {
            var u = U(a.target, ".fc-event-forced-url"),
              c = u ? u.querySelector("a[href]").href : "";
        ...
        (n.destroy = Fn(r.el, "click", ".fc-event", n.handleSegClick)),
        n
      );
    }
    return e;
  ...
  vu = (function (t) {
    ...
    function e(r) {
      var n = t.call(this, r) || this;
      return (
        (n.handleEventElRemove = function (a) {
          a === n.currentSegEl && n.handleSegLeave(null, n.currentSegEl);
        }),
        (n.handleSegEnter = function (a, i) {
          Se(i) &&
            ((n.currentSegEl = i), n.triggerEvent("eventMouseEnter", a, i));
        }),
        (n.handleSegLeave = function (a, i) {
          n.currentSegEl &&
            ((n.currentSegEl = null), n.triggerEvent("eventMouseLeave", a, i));
        }),
        (n.removeHoverListeners = Ni(
          r.el,
          ".fc-event",
          n.handleSegEnter,
          n.handleSegLeave
  ...
  pu = (function (t) {
    ...
    function e() {
      var r = (t !== null && t.apply(this, arguments)) || this;
      return (
        (r.buildViewContext = M(Zs)),
        (r.buildViewPropTransformers = M(gu)),
        (r.buildToolbarProps = M(hu)),
        (r.headerRef = G()),
        (r.footerRef = G()),
        (r.interactionsStore = {}),
        (r.state = { viewLabelId: ut() }),
        (r.registerInteractiveComponent = function (n, a) {
          var i = uu(n, a),
            o = [fu, vu],
            s = o.concat(r.props.pluginHooks.componentInteractions),
            l = s.map(function (u) {
              return new u(i);
            });
        ...
        (r.resizeRunner = new hr(function () {
          r.props.emitter.trigger("_resize", !0),
            r.props.emitter.trigger("windowResize", { view: r.props.viewApi });
        })),
        (r.handleWindowResize = function (n) {
          var a = r.props.options;
          a.handleWindowResize &&
            n.target === window &&
            r.resizeRunner.request(a.windowResizeDelay);
        }),
        r
      );
    }
    return (
      (e.prototype.render = function () {
        var r = this.props,
          ...
          s = "",
          l;
        r.isHeightAuto || r.forPrint
          ? (s = "")
          : a.height != null
          ? (o = !0)
          : a.contentHeight != null
          ? (s = a.contentHeight)
          : (l = Math.max(a.aspectRatio, 0.5));
        var u = this.buildViewContext(
            r.viewSpec,
            r.viewApi,
            r.options,
            r.dateProfileGenerator,
      ...
      (e.prototype.componentDidMount = function () {
        var r = this.props;
        (this.calendarInteractions = r.pluginHooks.calendarInteractions.map(
          function (i) {
            return new i(r);
          }
        )),
        ...
        for (var a in n) n[a](r[a], r);
      }),
      (e.prototype.componentDidUpdate = function (r) {
        var n = this.props,
          a = n.pluginHooks.propSetHandlers;
        for (var i in a) n[i] !== r[i] && a[i](n[i], n);
      }),
      (e.prototype.componentWillUnmount = function () {
      ...
      (e.prototype.buildAppendContent = function () {
        var r = this.props,
          n = r.pluginHooks.viewContainerAppends.map(function (a) {
            return a(r);
          });
...
function hu(t, e, r, n, a, i) {
  var o = r.build(a, void 0, !1),
    s = r.buildPrev(e, n, !1),
    l = r.buildNext(e, n, !1);
  return {
    title: i,
...
var mu = (function (t) {
  ...
  return (
    (e.prototype.render = function () {
      var r = this.props,
        n = r.options,
        a = this.state.forPrint,
        i = a || n.height === "auto" || n.contentHeight === "auto",
        o = !i && n.height != null ? n.height : "",
        s = [
          "fc",
      ...
      return pa() || s.push("fc-liquid-hack"), r.children(s, o, i, a);
    }),
    (e.prototype.componentDidMount = function () {
      var r = this.props.emitter;
      r.on("_beforeprint", this.handleBeforePrint),
        r.on("_afterprint", this.handleAfterPrint);
    }),
    (e.prototype.componentWillUnmount = function () {
      var r = this.props.emitter;
      r.off("_beforeprint", this.handleBeforePrint),
        r.off("_afterprint", this.handleAfterPrint);
    }),
    e
  );
})(x);
...
var Eu = (function (t) {
    ...
    return (
      (e.prototype.render = function () {
        var r = this.context,
          ...
          l = s.date,
          u = s.dateProfile,
          c = ha(l, s.todayRange, null, u),
          d = [xa].concat(ur(c, i)),
          f = n.format(l, s.dayHeaderFormat),
          v = !c.isDisabled && s.colCnt > 1 ? cr(this.context, l) : {},
          p = h(
            h(h({ date: n.toDate(l), view: o }, s.extraHookProps), { text: f }),
            c
          );
        return m(
          Re,
              ...
              h(
                {
                  ref: E,
                  role: "columnheader",
                  className: d.concat(S).join(" "),
                  "data-date": c.isDisabled ? void 0 : jn(l),
                  colSpan: s.colSpan,
                },
                s.extraDataAttrs
              ),
    ...
    return (
      (e.prototype.render = function () {
        var r = this.props,
          ...
          c = [xa].concat(ur(u, i), r.extraClassNames || []),
          d = a.format(l, r.dayHeaderFormat),
          f = h(h(h(h({ date: l }, u), { view: o }), r.extraHookProps), {
            text: d,
          });
        return m(
          Re,
  ...
  Na = (function (t) {
    ...
    function e(r, n) {
      ...
      return (
        (a.initialNowDate = Ne(n.options.now, n.dateEnv)),
        (a.initialNowQueriedMs = new Date().valueOf()),
        (a.state = a.computeTiming().currentState),
        a
      );
    }
    return (
      ...
      (e.prototype.computeTiming = function () {
        var r = this,
          ...
          o = a.dateEnv.startOf(i, n.unit),
          s = a.dateEnv.add(o, I(1, n.unit)),
          l = s.valueOf() - i.valueOf();
        return (
...
var Du = (function (t) {
  ...
  function e() {
    var r = (t !== null && t.apply(this, arguments)) || this;
    return (r.createDayHeaderFormatter = M(Cu)), r;
  }
  return (
    (e.prototype.render = function () {
      var r = this.context,
        ...
        l = this.createDayHeaderFormatter(
          r.options.dayHeaderFormat,
          o,
          a.length
        );
      return m(Na, { unit: "day" }, function (u, c) {
        return m(
          "tr",
          { role: "row" },
          s && s("day"),
...
var Ru = (function () {
    function t(e, r) {
      for (var n = e.start, a = e.end, i = [], o = [], s = -1; n < a; )
        r.isHiddenDay(n) ? i.push(s + 0.5) : ((s += 1), i.push(s), o.push(n)),
          (n = W(n, 1));
      (this.dates = o), (this.indices = i), (this.cnt = o.length);
    }
    return (
      (t.prototype.sliceRange = function (e) {
        var r = this.getDateDayIndex(e.start),
          n = this.getDateDayIndex(W(e.end, -1)),
          a = Math.max(0, r),
        ...
        return (
          ...
          (i = Math.floor(i)),
          a <= i
            ? { firstIndex: a, lastIndex: i, isStart: r === a, isEnd: n === i }
            : null
        );
      }),
      (t.prototype.getDateDayIndex = function (e) {
        var r = this.indices,
          n = Math.floor(De(this.dates[0], e));
  ...
  Tu = (function () {
    function t() {
      (this.sliceBusinessHours = M(this._sliceBusinessHours)),
        (this.sliceDateSelection = M(this._sliceDateSpan)),
        (this.sliceEventStore = M(this._sliceEventStore)),
        (this.sliceEventDrag = M(this._sliceInteraction)),
        (this.sliceEventResize = M(this._sliceInteraction)),
        (this.forceDayIfListItem = !1);
    }
    return (
      (t.prototype.sliceProps = function (e, r, n, a) {
        for (var i = [], o = 4; o < arguments.length; o++)
          i[o - 4] = arguments[o];
        var s = e.eventUiBases,
          l = this.sliceEventStore.apply(this, A([e.eventStore, s, r, n], i));
        return {
          dateSelectionSegs: this.sliceDateSelection.apply(
            this,
            A([e.dateSelection, s, a], i)
          ),
          businessHourSegs: this.sliceBusinessHours.apply(
            this,
            A([e.businessHours, r, n, a], i)
          ),
          fgEventSegs: l.fg,
          bgEventSegs: l.bg,
          eventDrag: this.sliceEventDrag.apply(
            this,
            A([e.eventDrag, s, r, n], i)
          ),
          eventResize: this.sliceEventResize.apply(
            this,
            A([e.eventResize, s, r, n], i)
          ),
      ...
      (t.prototype.sliceNowDate = function (e, r) {
        ...
        return this._sliceDateSpan.apply(
          this,
          A([{ range: { start: e, end: le(e, 1) }, allDay: !1 }, {}, r], n)
        );
      }),
      ...
      (t.prototype._sliceDateSpan = function (e, r, n) {
        ...
        for (
          var o = is(e, r, n),
            s = this.sliceRange.apply(this, A([e.range], a)),
            l = 0,
            u = s;
          l < u.length;
          l++
      ...
      (t.prototype.sliceEventRange = function (e, r) {
        ...
        this.forceDayIfListItem &&
          ...
          (n = { start: n.start, end: W(n.start, 1) });
        for (
          var a = this.sliceRange.apply(this, A([n], r)), i = 0, o = a;
          i < o.length;
          i++
        ) {
          var s = o[i];
...
function Oa(t, e, r) {
  ...
  for (var a in n) if (!ft(e.validRange, n[a].range)) return !1;
  return La({ eventDrag: t }, r);
}
function _u(t, e, r) {
  return ft(e.validRange, t.range) ? La({ dateSelection: t }, r) : !1;
}
function La(t, e) {
  var r = e.getCurrentData(),
    n = h(
      {
        businessHours: r.businessHours,
        dateSelection: "",
  ...
  return (e.pluginHooks.isPropsValid || Mu)(n, e);
}
function Mu(t, e, r, n) {
  return (
    r === void 0 && (r = {}),
    !((t.eventDrag && !ku(t, e, r, n)) || (t.dateSelection && !Iu(t, e, r, n)))
  );
}
function ku(t, e, r, n) {
  var a = e.getCurrentData(),
    i = t.eventDrag,
    o = i.mutatedEvents,
    s = o.defs,
    l = o.instances,
    u = ot(s, i.isEvent ? t.eventUiBases : { "": a.selectionConfig });
  n && (u = ce(u, n));
  var c = Rl(t.eventStore, i.affectedEvents.instances),
    d = c.defs,
    f = c.instances,
    v = ot(d, t.eventUiBases);
  for (var p in l) {
    var E = l[p],
      S = E.range,
      g = u[E.defId],
      b = s[E.defId];
    if (!Va(g.constraints, S, c, t.businessHours, e)) return !1;
    var D = e.options.eventOverlap,
    ...
    for (var k in f) {
      ...
      if (or(S, T.range)) {
        ...
        if (
          (P === !1 && i.isEvent) ||
          g.overlap === !1 ||
          (C && !C(new N(e, d[T.defId], T), new N(e, b, E)))
        )
          return !1;
      }
    }
    for (var _ = a.eventStore, O = 0, L = g.allows; O < L.length; O++) {
      var Z = L[O],
        z = h(h({}, r), { range: E.range, allDay: b.allDay }),
        Ve = _.defs[b.defId],
        Ue = _.instances[p],
        mt = void 0;
...
function Iu(t, e, r, n) {
  var a = t.eventStore,
    ...
    s = t.dateSelection,
    l = s.range,
    u = e.getCurrentData().selectionConfig;
  if ((n && (u = n(u)), !Va(u.constraints, l, a, t.businessHours, e)))
    return !1;
  var c = e.options.selectOverlap,
    d = typeof c == "function" ? c : null;
  for (var f in o) {
    var v = o[f];
    if (
      or(l, v.range) &&
      (u.overlap === !1 || (d && !d(new N(e, i[v.defId], v), null)))
    )
      return !1;
  }
...
function Va(t, e, r, n, a) {
  for (var i = 0, o = t; i < o.length; i++) {
    var s = o[i];
    if (!Hu(Pu(s, e, r, n, a), e)) return !1;
  }
  return !0;
}
function Pu(t, e, r, n, a) {
...
function Ht(t) {
  var e = t.instances,
    r = [];
  for (var n in e) r.push(e[n].range);
  return r;
}
function Hu(t, e) {
  ...
  xu = (function (t) {
    ...
    return (
      ...
      (e.prototype.needsXScrolling = function () {
        if (Fe.test(this.props.overflowX)) return !1;
        for (
          var r = this.el,
            n =
          ...
          var o = a[i];
          if (o.getBoundingClientRect().width > n) return !0;
        }
        return !1;
      }),
      (e.prototype.needsYScrolling = function () {
        if (Fe.test(this.props.overflowY)) return !1;
        for (
          var r = this.el,
            n =
      ...
      (this.masterCallback = e),
        ...
        (this.handleValue = function (n, a) {
          var i = r,
            ...
            u = !1;
          n !== null
            ? ((l = a in s), (s[a] = n), (o[a] = (o[a] || 0) + 1), (u = !0))
            : ((o[a] -= 1),
              o[a] || (delete s[a], delete r.callbackMap[a], (l = !0))),
            r.masterCallback &&
              (l && r.masterCallback(null, String(a)),
              u && r.masterCallback(n, String(a)));
        });
    }
    return (
      ...
      (t.prototype.collect = function (e, r, n) {
        return oo(this.currentMap, e, r, n);
      }),
...
function Au(t) {
  for (
    var e = Hi(t, ".fc-scrollgrid-shrink"), r = 0, n = 0, a = e;
    n < a.length;
    n++
  ) {
    var i = a[n];
  ...
  for (var r = [], n = 0, a = t; n < a.length; n++)
    for (var i = a[n], o = i.span || 1, s = 0; s < o; s += 1)
      r.push(
        m("col", {
          style: {
            width: i.width === "shrink" ? Uu(e) : i.width || "",
            minWidth: i.minWidth || "",
          },
        })
      );
...
function Wu(t) {
  for (var e = 0, r = t; e < r.length; e++) {
    var n = r[e];
    if (n.width === "shrink") return !0;
  }
  return !1;
}
function Bu(t, e) {
  var r = ["fc-scrollgrid", e.theme.getClass("table")];
...
function Fu(t, e) {
  ...
  return (
    e &&
      t.liquid &&
      t.maxHeight == null &&
      r.push("fc-scrollgrid-section-liquid"),
    t.isSticky && r.push("fc-scrollgrid-section-sticky"),
    r
  );
}
function zu(t) {
...
var Wa = (function (t) {
  ...
  function e() {
    var r = (t !== null && t.apply(this, arguments)) || this;
    return (
      (r.processCols = M(function (n) {
        return n;
      }, Lu)),
      (r.renderMicroColGroup = M(Vu)),
      (r.scrollerRefs = new ae()),
      (r.scrollerElRefs = new ae(r._handleScrollerEl.bind(r))),
      (r.state = {
        shrinkWidth: null,
        forceYScrollbars: !1,
      ...
      (r.handleSizing = function () {
        r.safeSetState(
          h({ shrinkWidth: r.computeShrinkWidth() }, r.computeScrollerDims())
        );
      }),
      r
    );
  ...
  return (
    (e.prototype.render = function () {
      var r = this,
        ...
        i = r.context,
        o = n.sections || [],
        s = this.processCols(n.cols),
        l = this.renderMicroColGroup(s, a.shrinkWidth),
        u = Bu(n.liquid, i);
      n.collapsibleWidth && u.push("fc-scrollgrid-collapsible");
      for (
        var c = o.length, d = 0, f, v = [], p = [], E = [];
        d < c && (f = o[d]).type === "header";

      )
        v.push(this.renderSection(f, l, !0)), (d += 1);
      for (; d < c && (f = o[d]).type === "body"; )
        p.push(this.renderSection(f, l, !1)), (d += 1);
      for (; d < c && (f = o[d]).type === "footer"; )
        E.push(this.renderSection(f, l, !0)), (d += 1);
      var S = !pa(),
        g = { role: "rowgroup" };
      return m(
        "table",
        { role: "grid", className: u.join(" "), style: { height: n.height } },
        Boolean(!S && v.length) && m.apply(void 0, A(["thead", g], v)),
        Boolean(!S && p.length) && m.apply(void 0, A(["tbody", g], p)),
        Boolean(!S && E.length) && m.apply(void 0, A(["tfoot", g], E)),
        S && m.apply(void 0, A(A(A(["tbody", g], v), p), E))
      );
    }),
    (e.prototype.renderSection = function (r, n, a) {
      return "outerContent" in r
        ? m(B, { key: r.key }, r.outerContent)
        : m(
            "tr",
            {
              key: r.key,
              role: "presentation",
              className: Fu(r, this.props.liquid).join(" "),
            },
            this.renderChunkTd(r, n, r.chunk, a)
          );
    }),
    (e.prototype.renderChunkTd = function (r, n, a, i) {
      if ("outerContent" in a) return a.outerContent;
      var o = this.props,
        s = this.state,
        l = s.forceYScrollbars,
        u = s.scrollerClientWidths,
        c = s.scrollerClientHeights,
        d = Nu(o, r),
        f = Ua(o, r),
        v = o.liquid ? (l ? "scroll" : d ? "auto" : "hidden") : "visible",
        p = r.key,
        E = Ou(
          r,
          a,
      ...
      return m(
        i ? "th" : "td",
        { ref: a.elRef, role: "presentation" },
        m(
          "div",
          {
            className:
              "fc-scroller-harness" + (f ? " fc-scroller-harness-liquid" : ""),
          },
          m(
            xu,
            {
    ...
    (e.prototype._handleScrollerEl = function (r, n) {
      var a = qu(this.props.sections, n);
    ...
    (e.prototype.computeShrinkWidth = function () {
      return Wu(this.props.cols) ? Au(this.scrollerElRefs.getAll()) : 0;
    }),
    (e.prototype.computeScrollerDims = function () {
      ...
      for (var d = 0, f = this.props.sections; d < f.length; d++) {
        ...
        if (p) {
          var E = p.parentNode;
          (s[u] = Math.floor(E.getBoundingClientRect().width - (o ? r.y : 0))),
            (l[u] = Math.floor(E.getBoundingClientRect().height));
        }
      }
      return {
        forceYScrollbars: o,
...
Wa.addStateEquality({ scrollerClientWidths: X, scrollerClientHeights: X });
function qu(t, e) {
  for (var r = 0, n = t; r < n.length; r++) {
    var a = n[r];
    if (a.key === e) return a;
      ...
      (e.prototype.render = function () {
        var r = this,
          ...
          u = {
            ...
            isDraggable: !n.disableDragging && Zo(o, a),
            isStartResizable: !n.disableResizing && Xo(o, a),
            isEndResizable: !n.disableResizing && $o(o),
            isMirror: Boolean(
              n.isDragging || n.isResizing || n.isDateSelecting
            ),
          ...
          c = Ko(u).concat(l.classNames);
        return m(
          Re,
          {
            hookProps: u,
            classNames: i.eventClassNames,
            content: i.eventContent,
            defaultContent: n.defaultContent,
            didMount: i.eventDidMount,
            willUnmount: i.eventWillUnmount,
            elRef: this.elRef,
          },
          function (d, f, v, p) {
            return n.children(d, c.concat(f), v, p, u);
          }
        );
      }),
      (e.prototype.componentDidMount = function () {
    ...
    return (
      (e.prototype.render = function () {
        var r = this,
          ...
          a = r.context,
          i = n.seg,
          o = a.options.eventTimeFormat || n.defaultTimeFormat,
          s = ea(i, o, a, n.defaultDisplayEventTime, n.defaultDisplayEventEnd);
        return m(
          yr,
          {
            seg: i,
            ...
            defaultContent: n.defaultContent || ju,
          ...
          function (l, u, c, d, f) {
            return m(
              ...
              h(
                {
                  className: n.extraClassNames.concat(u).join(" "),
                  style: {
              ...
              f.isEndResizable &&
                m("div", { className: "fc-event-resizer fc-event-resizer-end" })
            );
          }
        );
      }),
  ...
  return m(
    ...
    m(
      ...
      m(
        ...
        t.event.title || m(B, null, "\xA0")
      )
    )
  );
}
var Zu = V({ day: "numeric" }),
  Ba = (function (t) {
    R(e, t);
    function e() {
      return (t !== null && t.apply(this, arguments)) || this;
...
function Fa(t) {
  var e = t.date,
    r = t.dateEnv,
    n = ha(e, t.todayRange, null, t.dateProfile);
  return h(
    h(h({ date: r.toDate(e), view: t.viewApi }, n), {
      dayNumberText: t.showDayNumber ? r.format(e, Zu) : "",
    }),
    t.extraProps
  );
}
var za = (function (t) {
  ...
  function e() {
    var r = (t !== null && t.apply(this, arguments)) || this;
    return (r.refineHookProps = je(Fa)), (r.normalizeClassNames = Sa()), r;
  }
  return (
    (e.prototype.render = function () {
      var r = this,
        ...
        s = ur(o, a.theme).concat(
          o.isDisabled ? [] : this.normalizeClassNames(i.dayCellClassNames, o)
        ),
        l = o.isDisabled ? {} : { "data-date": jn(n.date) };
      return m(
        vr,
        {
          hookProps: o,
          didMount: i.dayCellDidMount,
          willUnmount: i.dayCellWillUnmount,
          elRef: n.elRef,
        },
        function (u) {
  ...
  return m(
    ...
    function (e, r, n, a, i) {
      return m(
        ...
        {
          ref: e,
          className: ["fc-bg-event"].concat(r).join(" "),
...
var Ju = function (t) {
  return m(de.Consumer, null, function (e) {
    var r = e.dateEnv,
      n = e.options,
      a = t.date,
      i = n.weekNumberFormat || t.defaultFormat,
      o = r.computeWeekNumber(a),
      s = r.format(a, i),
      l = { num: o, text: s, date: a };
    return m(
      Re,
      {
        hookProps: l,
...
var xt = 10,
    ...
    return (
      (e.prototype.render = function () {
        var r = this.context,
          ...
          o = i.props,
          s = i.state,
          l = ["fc-popover", n.getClass("popover")].concat(
            o.extraClassNames || []
          );
        return ki(
          m(
            ...
            m(
              ...
              m(
                "span",
                { className: "fc-popover-title", id: s.titleId },
                o.title
              ),
              m("span", {
                className: "fc-popover-close " + n.getIconClass("close"),
                title: a.closeHint,
            ...
            m(
              "div",
              { className: "fc-popover-body " + n.getClass("popoverContent") },
              o.children
            )
          ),
          o.parentEl
      ...
      (e.prototype.updateSize = function () {
        ...
        if (s) {
          var l = o.getBoundingClientRect(),
            u = i ? U(a, ".fc-scrollgrid").getBoundingClientRect().top : s.top,
            c = r ? s.right - l.width : s.left;
          (u = Math.max(u, xt)),
            (c = Math.min(
              c,
              document.documentElement.clientWidth - xt - l.width
            )),
            (c = Math.max(c, xt));
          var d = o.offsetParent.getBoundingClientRect();
          _e(o, { top: u - d.top, left: c - d.left });
        }
      }),
      e
    );
    ...
    function e() {
      ...
      return (
        (r.handleRootEl = function (n) {
          (r.rootEl = n),
            n
              ? r.context.registerInteractiveComponent(r, {
                  el: n,
                  useEventCenter: !1,
                })
    ...
    return (
      (e.prototype.render = function () {
        var r = this.context,
          ...
          s = i.todayRange,
          l = i.dateProfile,
          u = a.format(o, n.dayPopoverFormat);
        return m(
          za,
          { date: o, dateProfile: l, todayRange: s, elRef: this.handleRootEl },
          function (c, d, f) {
            return m(
              ec,
              {
                ...
                id: i.id,
                title: u,
                extraClassNames: ["fc-more-popover"].concat(d),
                extraAttrs: f,
                parentEl: i.parentEl,
              ...
              m(
                Ba,
                { date: o, dateProfile: l, todayRange: s },
                function (v, p) {
                  return (
                    p &&
                    m("div", { className: "fc-more-popover-misc", ref: v }, p)
                  );
                }
              ),
              i.children
      ...
      (e.prototype.queryHit = function (r, n, a, i) {
        ...
        return r >= 0 && r < a && n >= 0 && n < i
          ? {
              ...
              dayEl: s,
              rect: { left: 0, top: 0, right: a, bottom: i },
              layer: 1,
            }
          : null;
      }),
  ...
  rc = (function (t) {
    ...
    function e() {
      ...
      return (
        (r.linkElRef = G()),
        (r.state = { isPopoverOpen: !1, popoverId: ut() }),
        (r.handleClick = function (n) {
          var a = r,
            i = a.props,
            o = a.context,
            s = o.options.moreLinkClick,
            l = En(i).start;
          function u(c) {
            var d = c.eventRange,
              f = d.def,
          ...
          typeof s == "function" &&
            ...
            !s || s === "popover"
              ? r.setState({ isPopoverOpen: !0 })
              : typeof s == "string" && o.calendarApi.zoomTo(l, s);
        }),
    ...
    return (
      (e.prototype.render = function () {
        ...
        return m(de.Consumer, null, function (o) {
          var s = o.viewApi,
            ...
            d = a.moreCnt,
            f = En(a),
            v = typeof c == "function" ? c.call(u, d) : "+" + d + " " + c,
            p = Me(l.moreLinkHint, [d], v),
            E = { num: d, shortText: "+" + d, text: v, view: s };
          return m(
            B,
            null,
            Boolean(a.moreCnt) &&
              m(
                Re,
                {
                  elRef: r.linkElRef,
                  hookProps: E,
                  classNames: l.moreLinkClassNames,
                  content: l.moreLinkContent,
                  defaultContent: a.defaultContent || nc,
                ...
                function (S, g, b, D) {
                  return a.children(
                    S,
                    ["fc-more-link"].concat(g),
                    b,
                    D,
                    r.handleClick,
                    p,
                    i.isPopoverOpen,
                    i.isPopoverOpen ? i.popoverId : ""
                  );
                }
              ),
            i.isPopoverOpen &&
              m(
                tc,
                {
                  ...
                  parentEl: r.parentEl,
                  alignmentEl: a.alignmentElRef.current,
                  alignGridTop: a.alignGridTop,
                  onClose: r.handlePopoverClose,
                },
                a.popoverContent()
              )
          );
      ...
      (e.prototype.updateParentEl = function () {
        this.linkElRef.current &&
          (this.parentEl = U(this.linkElRef.current, ".fc-view-harness"));
      }),
      e
    );
  })(x);
...
function En(t) {
  if (t.allDayDate) return { start: t.allDayDate, end: W(t.allDayDate, 1) };
  var e = t.hiddenSegs;
  return { start: ac(e), end: oc(e) };
}
function ac(t) {
  return t.reduce(ic).eventRange.range.start;
}
function ic(t, e) {
  return t.eventRange.range.start < e.eventRange.range.start ? t : e;
}
function oc(t) {
  return t.reduce(sc).eventRange.range.end;
}
function sc(t, e) {
...
*/ var lc = (function (t) {
  ...
  function e(r, n) {
    ...
    return (
      ...
      (a.isRendered = !1),
      (a.currentClassNames = []),
      (a.customContentRenderId = 0),
      (a.handleAction = function (i) {
        switch (i.type) {
          case "SET_EVENT_DRAG":
          case "SET_EVENT_RESIZE":
      ...
      (a.handleData = function (i) {
        (a.currentData = i),
          a.renderRunner.request(i.calendarOptions.rerenderDelay);
      }),
                ...
                function (o, s, l, u) {
                  return (
                    ...
                    m(
                      ...
                      m(pu, h({ isHeightAuto: l, forPrint: u }, i))
                    )
                  );
                }
              ),
      ...
      (a.el = r),
      (a.renderRunner = new hr(a.handleRenderRequest)),
      new Ia({
        optionOverrides: n,
        calendarApi: a,
  ...
  return (
    ...
    (e.prototype.render = function () {
      ...
      r ? (this.customContentRenderId += 1) : (this.isRendering = !0),
    ...
    (e.prototype.setClassNames = function (r) {
      if (!Ee(r, this.currentClassNames)) {
        for (
          var n = this.el.classList, a = 0, i = this.currentClassNames;
          a < i.length;
          a++
        ) {
          var o = i[a];
...
*/ var uc = (function (t) {
  ...
  return (
    (e.prototype.renderSimpleLayout = function (r, n) {
      var a = this,
        i = a.props,
        o = a.context,
        s = [],
    ...
    (e.prototype.renderHScrollLayout = function (r, n, a, i) {
      ...
      var s = this,
        l = s.props,
        u = s.context,
        c = !l.forPrint && yn(u.options),
        d = !l.forPrint && Gu(u.options),
        f = [];
      return (
        r &&
          f.push({
        ...
        m(zt, { viewSpec: u.viewSpec }, function (v, p) {
          return m(
            ...
            m(o, {
              ...
              colGroups: [{ cols: [{ span: a, minWidth: i }] }],
              sections: f,
            })
          );
        })
...
function Sn(t, e) {
  ...
  } else for (var n = 0; n < e; n += 1) r[n] = null;
  return r;
}
var cc = (function (t) {
  R(e, t);
        ...
        function (a, i) {
          return (
            ...
            m(
              ...
              m(
                "a",
                h({ id: r.dayNumberId, className: "fc-daygrid-day-number" }, n),
                i || m(B, null, "\xA0")
              )
            )
          );
      ...
      (e.prototype.render = function () {
        ...
        return m(
          ...
          h({}, r, {
            ...
            defaultTimeFormat: Ga,
            defaultDisplayEventEnd: r.defaultDisplayEventEnd,
            disableResizing: !r.seg.eventRange.def.allDay,
          })
        );
      }),
      e
    ...
    return (
      (e.prototype.render = function () {
        var r = this,
          n = r.props,
          a = r.context,
          i = a.options.eventTimeFormat || Ga,
          o = ea(n.seg, i, a, !0, n.defaultDisplayEventEnd);
        return m(
          yr,
          {
            seg: n.seg,
...
var vc = (function (t) {
  ...
  function e() {
    var r = (t !== null && t.apply(this, arguments)) || this;
    return (r.compileSegs = M(pc)), r;
  }
  return (
    (e.prototype.render = function () {
      var r = this.props,
        n = this.compileSegs(r.singlePlacements),
        a = n.allSegs,
        i = n.invisibleSegs;
      return m(
        rc,
        ...
        function (o, s, l, u, c, d, f, v) {
          return m(
            "a",
            h(
              {
                ref: o,
                className: ["fc-daygrid-more-link"].concat(s).join(" "),
                title: d,
                "aria-expanded": f,
                "aria-controls": v,
              },
      ...
      (e.prototype.render = function () {
        ...
        return m(
          za,
          {
            ...
            extraHookProps: a.extraHookProps,
            elRef: this.handleRootEl,
          },
          function (c, d, f, v) {
            return m(
              ...
              h(
                {
                  ...
                  className: ["fc-daygrid-day"]
                    .concat(d, a.extraClassNames || [])
                    .join(" "),
                },
                f,
                a.extraDataAttrs,
                a.showDayNumber ? { "aria-labelledby": i.dayNumberId } : {}
              ),
              m(
                "div",
                {
                ...
                a.showWeekNumber &&
                  m(Ju, { date: s, defaultFormat: hc }, function (p, E, S, g) {
                    return m(
                      "a",
                      h(
                        {
                ...
                m(
                  ...
                  m(
                    "div",
                    {
                      ...
                      style: { marginTop: a.moreMarginTop },
                    },
                    m(vc, {
                      allDayDate: s,
                      singlePlacements: a.singlePlacements,
                      moreCnt: a.moreCnt,
                      alignmentElRef: o,
                      alignGridTop: !a.showDayNumber,
                      extraDateSpan: a.extraDateSpan,
                      dateProfile: a.dateProfile,
...
function mc(t, e, r, n, a, i, o) {
  ...
  (s.allowReslicing = !0),
    ...
    e === !0 || r === !0
      ...
      : typeof e == "number"
      ? (s.maxStackCnt = e)
      : typeof r == "number" && ((s.maxStackCnt = r), (s.hiddenConsumes = !0));
  for (var l = [], u = [], c = 0; c < t.length; c += 1) {
    var d = t[c],
      f = d.eventRange.instance.instanceId,
      v = a[f];
    v != null
      ? l.push({
          index: c,
          thickness: v,
          span: { start: d.firstCol, end: d.lastCol + 1 },
        })
      : u.push(d);
  }
  for (
    var p = s.addSegs(l),
      E = s.toRects(),
      S = yc(E, t, o),
      g = S.singleColPlacements,
      b = S.multiColPlacements,
      D = S.leftoverMargins,
      C = [],
      k = [],
      T = 0,
    ...
    for (var _ = d.firstCol; _ <= d.lastCol; _ += 1)
      g[_].push({
        seg: ge(d, _, _ + 1, o),
        isVisible: !1,
        isAbsolute: !1,
  ...
  for (var _ = 0; _ < o.length; _ += 1) C.push(0);
  for (var O = 0, L = p; O < L.length; O++) {
    var Z = L[O],
      d = t[Z.index],
      z = Z.span;
    b[z.start].push({
      seg: ge(d, z.start, z.end, o),
      isVisible: !1,
      isAbsolute: !0,
      absoluteTop: 0,
      marginTop: 0,
  ...
  for (var _ = 0; _ < o.length; _ += 1) k.push(D[_]);
  return {
    singleColPlacements: g,
    multiColPlacements: b,
    moreCnts: C,
    moreMarginTops: k,
  };
}
function yc(t, e, r) {
  for (
    var n = Ec(t, r.length), a = [], i = [], o = [], s = 0;
    s < r.length;
    s += 1
  ) {
    for (var l = n[s], u = [], c = 0, d = 0, f = 0, v = l; f < v.length; f++) {
      var p = v[f],
        E = e[p.index];
      u.push({
        seg: ge(E, s, s + 1, r),
    ...
    a.push(u), i.push(S), o.push(d);
  }
  return { singleColPlacements: a, multiColPlacements: i, leftoverMargins: o };
}
function Ec(t, e) {
  for (var r = [], n = 0; n < e; n += 1) r.push([]);
  for (var a = 0, i = t; a < i.length; a++)
    for (var o = i[a], n = o.span.start; n < o.span.end; n += 1) r[n].push(o);
  return r;
}
function ge(t, e, r, n) {
  if (t.firstCol === e && t.lastCol === r - 1) return t;
  var a = t.eventRange,
    i = a.range,
    o = Ae(i, { start: n[e].date, end: W(n[r - 1].date, 1) });
  return h(h({}, t), {
    firstCol: e,
    lastCol: r - 1,
    eventRange: {
    ...
    isStart: t.isStart && o.start.valueOf() === i.start.valueOf(),
    isEnd: t.isEnd && o.end.valueOf() === i.end.valueOf(),
  });
}
var Sc = (function (t) {
    R(e, t);
    ...
    return (
      (e.prototype.addSegs = function (r) {
        for (
          var n = this,
            a = t.prototype.addSegs.call(this, r),
        ...
        if (this.hiddenConsumes && l) {
          ...
          if (!s[d])
            if (this.allowReslicing) {
              var f = h(h({}, l), { span: Pa(l.span, n.span) }),
                v = Pe(f);
              (s[v] = !0), (o[u][c] = f), this.splitEntry(l, n, a);
            } else (s[d] = !0), a.push(l);
        }
  ...
  Za = (function (t) {
    ...
    function e() {
      ...
      return (
        (r.cellElRefs = new ae()),
        (r.frameElRefs = new ae()),
        (r.fgElRefs = new ae()),
        (r.segHarnessRefs = new ae()),
        (r.rootElRef = G()),
        (r.state = {
          framePositions: null,
    ...
    return (
      (e.prototype.render = function () {
        var r = this,
          ...
          s = o.options,
          l = a.cells.length,
          u = Ge(a.businessHourSegs, l),
          c = Ge(a.bgEventSegs, l),
          d = Ge(this.getHighlightSegs(), l),
          f = Ge(this.getMirrorSegs(), l),
          v = mc(
            Yo(a.fgEventSegs, s.eventOrder),
            a.dayMaxEvents,
            a.dayMaxEventRows,
            s.eventOrderStrict,
            i.eventInstanceHeights,
            i.maxContentHeight,
            a.cells
          ),
          p = v.singleColPlacements,
          E = v.multiColPlacements,
          S = v.moreCnts,
          g = v.moreMarginTops,
          b =
            (a.eventDrag && a.eventDrag.affectedInstances) ||
            (a.eventResize && a.eventResize.affectedInstances) ||
            {};
        return m(
          "tr",
          ...
          a.cells.map(function (D, C) {
            ...
            return m(gc, {
              key: D.key,
              elRef: r.cellElRefs.createRef(D.key),
              innerElRef: r.frameElRefs.createRef(D.key),
              dateProfile: a.dateProfile,
              date: D.date,
              showDayNumber: a.showDayNumbers,
              showWeekNumber: a.showWeekNumbers && C === 0,
              forceDayTop: a.showWeekNumbers,
              todayRange: a.todayRange,
              eventSelection: a.eventSelection,
              eventDrag: a.eventDrag,
              eventResize: a.eventResize,
              extraHookProps: D.extraHookProps,
              extraDataAttrs: D.extraDataAttrs,
              extraClassNames: D.extraClassNames,
              extraDateSpan: D.extraDateSpan,
              moreCnt: S[C],
              moreMarginTop: g[C],
              singlePlacements: p[C],
              fgContentElRef: r.fgElRefs.createRef(D.key),
              fgContent: m(B, null, m(B, null, k), m(B, null, T)),
              bgContent: m(
                B,
                null,
                r.renderFillSegs(d[C], "highlight"),
      ...
      (e.prototype.getHighlightSegs = function () {
        var r = this.props;
        return r.eventDrag && r.eventDrag.segs.length
          ? r.eventDrag.segs
          : r.eventResize && r.eventResize.segs.length
          ? r.eventResize.segs
          : r.dateSelectionSegs;
      }),
      (e.prototype.getMirrorSegs = function () {
        var r = this.props;
        return r.eventResize && r.eventResize.segs.length
          ? r.eventResize.segs
          : [];
      }),
      (e.prototype.renderFgSegs = function (r, n, a, i, o, s, l) {
        ...
        if (d)
          for (var E = 0, S = n; E < S.length; E++) {
            var g = S[E],
              b = g.seg,
              D = b.eventRange.instance.instanceId,
              C = D + ":" + r,
              k = g.isVisible && !i[D],
              T = g.isAbsolute,
              P = "",
            ...
            T &&
              (u.isRtl
                ? ((_ = 0), (P = d.lefts[b.lastCol] - d.lefts[b.firstCol]))
                : ((P = 0), (_ = d.rights[b.firstCol] - d.rights[b.lastCol]))),
              p.push(
                m(
                  "div",
                  {
                    className:
                      ...
                      (T ? " fc-daygrid-event-harness-abs" : ""),
                    key: C,
                    ref: v ? null : this.segHarnessRefs.createRef(C),
                    style: {
                      visibility: k ? "" : "hidden",
      ...
      (e.prototype.renderFillSegs = function (r, n) {
        ...
        if (o)
          for (var l = 0, u = r; l < u.length; l++) {
            var c = u[l],
              d = a
                ? { right: 0, left: o.lefts[c.lastCol] - o.lefts[c.firstCol] }
                : {
                    left: 0,
            ...
            s.push(
              m(
                ...
                n === "bg-event" ? m($u, h({ seg: c }, Ie(c, i))) : Xu(n)
              )
            );
          }
      ...
      (e.prototype.updateSizing = function (r) {
        ...
        if (!a.forPrint && a.clientWidth !== null) {
          if (r) {
            var o = a.cells.map(function (d) {
              return i.currentMap[d.key];
            });
            if (o.length) {
              var s = this.rootElRef.current;
              this.setState({ framePositions: new Bt(s, o, !0, !1) });
            }
          }
          var l = this.state.eventInstanceHeights,
            u = this.queryEventInstanceHeights(),
            c = a.dayMaxEvents === !0 || a.dayMaxEventRows === !0;
          this.safeSetState({
      ...
      (e.prototype.queryEventInstanceHeights = function () {
        var r = this.segHarnessRefs.currentMap,
          n = {};
        for (var a in r) {
          var i = Math.round(r[a].getBoundingClientRect().height),
            o = a.split(":")[0];
      ...
      (e.prototype.computeMaxContentHeight = function () {
        var r = this.props.cells[0].key,
          n = this.cellElRefs.currentMap[r],
          a = this.fgElRefs.currentMap[r];
...
Za.addStateEquality({ eventInstanceHeights: X });
function bc(t, e) {
  if (!t.length) return [];
  var r = Dc(e);
...
var Cc = (function (t) {
  ...
  function e() {
    var r = (t !== null && t.apply(this, arguments)) || this;
    return (
      (r.splitBusinessHourSegs = M(ze)),
      (r.splitBgEventSegs = M(ze)),
      (r.splitFgEventSegs = M(ze)),
      (r.splitDateSelectionSegs = M(ze)),
      (r.splitEventDrag = M(Sn)),
      (r.splitEventResize = M(Sn)),
      (r.rowRefs = new ae()),
      (r.handleRootEl = function (n) {
        (r.rootEl = n),
          n
  ...
  return (
    (e.prototype.render = function () {
      var r = this,
        ...
        s = n.expandRows,
        l = n.cells.length,
        u = this.splitBusinessHourSegs(n.businessHourSegs, l),
        c = this.splitBgEventSegs(n.bgEventSegs, l),
        d = this.splitFgEventSegs(n.fgEventSegs, l),
        f = this.splitDateSelectionSegs(n.dateSelectionSegs, l),
        v = this.splitEventDrag(n.eventDrag, l),
        p = this.splitEventResize(n.eventResize, l),
        E = o === !0 || i === !0;
              ...
              m(
                ...
                n.cells.map(function (D, C) {
                  return m(Za, {
                    ...
                    bgEventSegs: c[C].filter(Rc),
                    fgEventSegs: d[C],
                    dateSelectionSegs: f[C],
                    eventDrag: v[C],
                    eventResize: p[C],
                    dayMaxEvents: o,
                    dayMaxEventRows: i,
    ...
    (e.prototype.getCellRange = function (r, n) {
      var a = this.props.cells[r][n].date,
        i = W(a, 1);
...
var wc = (function (t) {
    ...
    return (
      (e.prototype.sliceRange = function (r, n) {
  ...
  Tc = (function (t) {
    ...
    function e() {
      var r = (t !== null && t.apply(this, arguments)) || this;
      return (r.slicer = new wc()), (r.tableRef = G()), r;
    }
    return (
      (e.prototype.render = function () {
        var r = this,
    ...
    return (
      (e.prototype.render = function () {
        var r = this,
          ...
          o = this.props,
          s = this.buildDayTableModel(o.dateProfile, i),
          l =
            a.dayHeaders &&
            m(Du, {
              ref: this.headerRef,
          ...
          u = function (c) {
            return m(Tc, {
              ...
              colGroupNode: c.tableColGroupNode,
              tableMinWidth: c.tableMinWidth,
              dayMaxEvents: a.dayMaxEvents,
              dayMaxEventRows: a.dayMaxEventRows,
              showWeekNumbers: a.weekNumbers,
              expandRows: !o.isHeightAuto,
              headerAlignElRef: r.headerElRef,
              clientWidth: c.clientWidth,
              clientHeight: c.clientHeight,
              forPrint: o.forPrint,
            });
          };
        return a.dayMinWidth
          ? this.renderHScrollLayout(l, u, s.colCnt, a.dayMinWidth)
          : this.renderSimpleLayout(l, u);
      }),
      e
    );
  })(uc);
function Mc(t, e) {
  var r = new Ru(t.renderRange, e);
  return new wu(r, /year|month|week/.test(t.currentRangeUnit));
}
var kc = (function (t) {
    R(e, t);
    function e() {
    ...
    return (
      (e.prototype.buildRenderRange = function (r, n, a) {
        var i = this.props.dateEnv,
          o = t.prototype.buildRenderRange.call(this, r, n, a),
          s = o.start,
          l = o.end,
          u;
        if (
          (/^(year|month)$/.test(n) &&
            ((s = i.startOfWeek(s)),
            (u = i.startOfWeek(l)),
            u.valueOf() !== l.valueOf() && (l = qr(u, 1))),
          this.props.monthMode && this.props.fixedWeekCount)
        ) {
          var c = Math.ceil(Zi(s, l));
          l = qr(l, 6 - c);
        }
  ...
  Ic = te({
    ...
    views: {
      dayGrid: { component: _c, dateProfileGeneratorClass: kc },
    ...
    function t(e) {
      ...
      (this.subjectEl = null),
        ...
        (this.handleMouseDown = function (n) {
          if (!r.shouldIgnoreMouse() && Pc(n) && r.tryStart(n)) {
            var a = r.createEventFromMouse(n, !0);
            r.emitter.trigger("pointerdown", a),
              r.initScrollWatch(a),
              r.shouldIgnoreMove ||
        ...
        (this.handleMouseUp = function (n) {
          document.removeEventListener("mousemove", r.handleMouseMove),
            ...
            r.emitter.trigger("pointerup", r.createEventFromMouse(n)),
            r.cleanup();
        }),
        (this.handleTouchStart = function (n) {
          if (r.tryStart(n)) {
            ...
            var i = n.target;
            r.shouldIgnoreMove ||
              i.addEventListener("touchmove", r.handleTouchMove),
              i.addEventListener("touchend", r.handleTouchEnd),
              i.addEventListener("touchcancel", r.handleTouchEnd),
        ...
        (this.handleTouchEnd = function (n) {
          if (r.isDragging) {
            var a = n.target;
            a.removeEventListener("touchmove", r.handleTouchMove),
              a.removeEventListener("touchend", r.handleTouchEnd),
              a.removeEventListener("touchcancel", r.handleTouchEnd),
              window.removeEventListener("scroll", r.handleTouchScroll, !0),
              r.emitter.trigger("pointerup", r.createEventFromTouch(n)),
              r.cleanup(),
              (r.isTouchDragging = !1),
              Hc();
          }
        ...
        (this.handleScroll = function (n) {
          if (!r.shouldIgnoreMove) {
            var a = window.pageXOffset - r.prevScrollX + r.prevPageX,
              i = window.pageYOffset - r.prevScrollY + r.prevPageY;
    ...
    return (
      ...
      (t.prototype.tryStart = function (e) {
        var r = this.querySubjectEl(e),
          n = e.target;
        return r && (!this.handleSelector || U(n, this.handleSelector))
          ? ((this.subjectEl = r),
            (this.isDragging = !0),
            (this.wasTouchScroll = !1),
            !0)
      ...
      (t.prototype.createEventFromMouse = function (e, r) {
        ...
        return (
          r
            ...
            : ((n = e.pageX - this.origPageX), (a = e.pageY - this.origPageY)),
          {
            origEvent: e,
            isTouch: !1,
      ...
      (t.prototype.createEventFromTouch = function (e, r) {
        ...
        return (
          n && n.length
            ? ((a = n[0].pageX), (i = n[0].pageY))
            : ((a = e.pageX), (i = e.pageY)),
          r
            ? ((this.origPageX = a), (this.origPageY = i))
            : ((o = a - this.origPageX), (s = i - this.origPageY)),
          {
            origEvent: e,
            isTouch: !0,
            subjectEl: this.subjectEl,
...
function xc() {
  (st += 1),
    st === 1 && window.addEventListener("touchmove", Xa, { passive: !1 });
}
function Ac() {
  (st -= 1), st || window.removeEventListener("touchmove", Xa, { passive: !1 });
}
function Xa(t) {
  Yt && t.preventDefault();
}
var Nc = (function () {
    ...
    return (
      (t.prototype.start = function (e, r, n) {
        (this.sourceEl = e),
          (this.sourceElRect = this.sourceEl.getBoundingClientRect()),
          (this.origScreenX = r - window.pageXOffset),
      ...
      (t.prototype.handleMove = function (e, r) {
        (this.deltaX = e - window.pageXOffset - this.origScreenX),
          (this.deltaY = r - window.pageYOffset - this.origScreenY),
          this.updateElPosition();
      }),
      ...
      (t.prototype.stop = function (e, r) {
        ...
        (this.deltaX || this.deltaY)
          ? this.doRevertAnimation(a, this.revertDuration)
          : setTimeout(a, 0);
      }),
      (t.prototype.doRevertAnimation = function (e, r) {
        var n = this.mirrorEl,
          a = this.sourceEl.getBoundingClientRect();
        (n.style.transition = "top " + r + "ms,left " + r + "ms"),
          _e(n, { left: a.left, top: a.top }),
          Oi(n, function () {
            (n.style.transition = ""), e();
          });
      }),
      (t.prototype.cleanup = function () {
        this.mirrorEl && (Xt(this.mirrorEl), (this.mirrorEl = null)),
          (this.sourceEl = null);
      }),
      ...
      (t.prototype.getMirrorEl = function () {
        ...
        return (
          r ||
            ((r = this.mirrorEl = this.sourceEl.cloneNode(!0)),
            r.classList.add("fc-unselectable"),
            r.classList.add("fc-event-dragging"),
            _e(r, {
              position: "fixed",
              zIndex: this.zIndex,
              visibility: "",
    ...
    function e(r, n) {
      ...
      return (
        (a.handleScroll = function () {
          (a.scrollTop = a.scrollController.getScrollTop()),
            (a.scrollLeft = a.scrollController.getScrollLeft()),
            a.handleScrollChange();
        }),
        (a.scrollController = r),
        (a.doesListening = n),
        (a.scrollTop = a.origScrollTop = r.getScrollTop()),
        (a.scrollLeft = a.origScrollLeft = r.getScrollLeft()),
        (a.scrollWidth = r.getScrollWidth()),
        (a.scrollHeight = r.getScrollHeight()),
        (a.clientWidth = r.getClientWidth()),
        (a.clientHeight = r.getClientHeight()),
        (a.clientRect = a.computeClientRect()),
        a.doesListening &&
          a.getEventTarget().addEventListener("scroll", a.handleScroll),
        a
      );
    }
    return (
      ...
      (e.prototype.setScrollTop = function (r) {
        this.scrollController.setScrollTop(r),
          this.doesListening ||
            ((this.scrollTop = Math.max(
              Math.min(r, this.getMaxScrollTop()),
              0
            )),
            this.handleScrollChange());
      }),
      (e.prototype.setScrollLeft = function (r) {
        this.scrollController.setScrollLeft(r),
          this.doesListening ||
            ((this.scrollLeft = Math.max(
              Math.min(r, this.getMaxScrollLeft()),
              0
            )),
            this.handleScrollChange());
      }),
  ...
  Ka = (function (t) {
    R(e, t);
    function e(r, n) {
      return t.call(this, new qs(r), n) || this;
    }
    return (
      ...
      (e.prototype.computeClientRect = function () {
        return Ws(this.scrollController.el);
      }),
      e
    );
  })($a),
  Oc = (function (t) {
    R(e, t);
    function e(r) {
      return t.call(this, new Ys(), r) || this;
    }
    return (
      (e.prototype.getEventTarget = function () {
        return window;
  ...
  bn = typeof performance == "function" ? performance.now : Date.now,
  Lc = (function () {
    function t() {
      var e = this;
      (this.isEnabled = !0),
      ...
      (t.prototype.handleMove = function (e, r) {
        if (this.isEnabled) {
          var n = e - window.pageXOffset,
            a = r - window.pageYOffset,
            i = this.pointerScreenY === null ? 0 : a - this.pointerScreenY,
            o = this.pointerScreenX === null ? 0 : n - this.pointerScreenX;
          i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
            o < 0
              ? (this.everMovedLeft = !0)
              : o > 0 && (this.everMovedRight = !0),
            (this.pointerScreenX = n),
            (this.pointerScreenY = a),
            this.isAnimating ||
              ((this.isAnimating = !0), this.requestAnimation(bn()));
        }
      }),
        ...
        for (
          ...
          c >= 0 &&
            ...
            (f <= n &&
              ...
              l.canScrollUp() &&
              (!a || a.distance > f) &&
              (a = { scrollCache: l, name: "top", distance: f }),
            v <= n &&
              this.everMovedDown &&
              l.canScrollDown() &&
              (!a || a.distance > v) &&
              (a = { scrollCache: l, name: "bottom", distance: v }),
            c <= n &&
              this.everMovedLeft &&
              l.canScrollLeft() &&
              (!a || a.distance > c) &&
              (a = { scrollCache: l, name: "left", distance: c }),
            d <= n &&
              this.everMovedRight &&
              l.canScrollRight() &&
              (!a || a.distance > d) &&
              (a = { scrollCache: l, name: "right", distance: d }));
        }
        return a;
      }),
      (t.prototype.buildCaches = function (e) {
        return this.queryScrollEls(e).map(function (r) {
          return r === window ? new Oc(!1) : new Ka(r, !1);
        });
      }),
      (t.prototype.queryScrollEls = function (e) {
        for (var r = [], n = 0, a = this.scrollQuery; n < a.length; n++) {
          ...
          typeof i == "object"
            ...
            : r.push.apply(
                r,
                Array.prototype.slice.call(Bn(e).querySelectorAll(i))
              );
        }
        return r;
      }),
  ...
  Le = (function (t) {
    ...
    function e(r, n) {
      ...
      (a.containerEl = r),
        (a.delay = null),
        (a.minDistance = 0),
        (a.touchScrollAllowed = !0),
        (a.mirrorNeedsRevert = !1),
        (a.isInteracting = !1),
        (a.isDragging = !1),
        (a.isDelayEnded = !1),
        (a.isDistanceSurpassed = !1),
        (a.delayTimeoutId = null),
        (a.onPointerDown = function (o) {
          a.isDragging ||
            ((a.isInteracting = !0),
            (a.isDelayEnded = !1),
            (a.isDistanceSurpassed = !1),
            Li(document.body),
            Ui(document.body),
            o.isTouch || o.origEvent.preventDefault(),
            a.emitter.trigger("pointerdown", o),
            a.isInteracting &&
              !a.pointer.shouldIgnoreMove &&
              (a.mirror.setIsVisible(!1),
              a.mirror.start(o.subjectEl, o.pageX, o.pageY),
              a.startDelay(o),
              a.minDistance || a.handleDistanceSurpassed(o)));
        }),
        (a.onPointerMove = function (o) {
          if (a.isInteracting) {
            ...
            a.isDragging &&
              (o.origEvent.type !== "scroll" &&
                (a.mirror.handleMove(o.pageX, o.pageY),
                a.autoScroller.handleMove(o.pageX, o.pageY)),
              a.emitter.trigger("dragmove", o));
          }
        }),
        (a.onPointerUp = function (o) {
          a.isInteracting &&
            ...
            Vi(document.body),
            Wi(document.body),
            a.emitter.trigger("pointerup", o),
            a.isDragging && (a.autoScroller.stop(), a.tryStopDrag(o)),
            a.delayTimeoutId &&
              (clearTimeout(a.delayTimeoutId), (a.delayTimeoutId = null)));
        });
      var i = (a.pointer = new Er(r));
      return (
        i.emitter.on("pointerdown", a.onPointerDown),
        i.emitter.on("pointermove", a.onPointerMove),
        i.emitter.on("pointerup", a.onPointerUp),
        n && (i.selector = n),
        (a.mirror = new Nc()),
        (a.autoScroller = new Lc()),
        a
      );
    }
    return (
      ...
      (e.prototype.tryStartDrag = function (r) {
        this.isDelayEnded &&
          ...
          this.autoScroller.start(r.pageX, r.pageY, this.containerEl),
  ...
  Vc = (function () {
    function t(e) {
      (this.origRect = dr(e)),
        (this.scrollCaches = ma(e).map(function (r) {
          return new Ka(r, !0);
        }));
    }
    return (
      ...
      (t.prototype.computeLeft = function () {
        for (
          var e = this.origRect.left, r = 0, n = this.scrollCaches;
          r < n.length;
          r++
        ) {
          var a = n[r];
      ...
      (t.prototype.computeTop = function () {
        for (
          var e = this.origRect.top, r = 0, n = this.scrollCaches;
          r < n.length;
          r++
        ) {
          var a = n[r];
      ...
      (t.prototype.isWithinClipping = function (e, r) {
        for (
          var n = { left: e, top: r }, a = 0, i = this.scrollCaches;
          a < i.length;
          a++
        ) {
          var o = i[a];
          if (!Uc(o.getEventTarget()) && !Ms(n, o.clientRect)) return !1;
        }
        return !0;
      }),
      t
...
var ht = (function () {
  function t(e, r) {
    ...
    (this.useSubjectCenter = !1),
      ...
      (this.movingHit = null),
      (this.finalHit = null),
      (this.handlePointerDown = function (a) {
        var i = n.dragging;
        (n.initialHit = null),
          (n.movingHit = null),
          (n.finalHit = null),
          n.prepareHits(),
          n.processFirstCoord(a),
          n.initialHit || !n.requireInitial
            ? (i.setIgnoreMove(!1), n.emitter.trigger("pointerdown", a))
            : i.setIgnoreMove(!0);
      }),
      ...
      (this.handleDragEnd = function (a) {
        n.movingHit && n.emitter.trigger("hitupdate", null, !0, a),
          (n.finalHit = n.movingHit),
          (n.movingHit = null),
          n.emitter.trigger("dragend", a);
      }),
  ...
  return (
    (t.prototype.processFirstCoord = function (e) {
      var r = { left: e.pageX, top: e.pageY },
        n = r,
        a = e.subjectEl,
        i;
      a instanceof HTMLElement && ((i = dr(a)), (n = ks(n, i)));
      ...
      for (var s in a) {
        ...
        if (u && u.isWithinClipping(e, r)) {
          var c = u.computeLeft(),
            ...
            S = p.bottom - p.top;
          if (f >= 0 && f < E && v >= 0 && v < S) {
            var g = l.queryHit(f, v, E, S);
            g &&
              ft(g.dateProfile.activeRange, g.dateSpan.range) &&
              (!o || g.layer > o.layer) &&
              ((g.componentId = s),
              (g.context = l.context),
              (g.rect.left += c),
...
function gt(t, e) {
  return !t && !e
    ...
    : Boolean(t) !== Boolean(e)
    ? !1
    : rs(t.dateSpan, e.dateSpan);
}
function Ja(t, e) {
  for (
    var r = {}, n = 0, a = e.pluginHooks.datePointTransforms;
    n < a.length;
    n++
  ) {
    var i = a[n];
      ...
      (n.handlePointerDown = function (i) {
        ...
        (n.handleDragEnd = function (i) {
          ...
          if (!s.wasTouchScroll) {
            ...
            if (u && c && gt(u, c)) {
              var d = o.context,
                f = h(h({}, Ja(u.dateSpan, d)), {
                  dayEl: u.dayEl,
                  jsEvent: i.origEvent,
                  view: d.viewApi || d.calendarApi.view,
                });
              d.emitter.trigger("dateClick", f);
            }
          }
        }),
        (n.dragging = new Le(r.el)),
  ...
  Fc = (function (t) {
    ...
    function e(r) {
      ...
      (n.dragSelection = null),
        (n.handlePointerDown = function (l) {
          var u = n,
            c = u.component,
            d = u.dragging,
            f = c.context.options,
            v = f.selectable && c.isValidDateDownEl(l.origEvent.target);
          d.setIgnoreMove(!v), (d.delay = l.isTouch ? zc(c) : null);
        }),
        (n.handleDragStart = function (l) {
          n.component.context.calendarApi.unselect(l);
        }),
        (n.handleHitUpdate = function (l, u) {
          var c = n.component.context,
            d = null,
            f = !1;
          if (l) {
            var v = n.hitDragging.initialHit,
              p =
                l.componentId === v.componentId &&
                n.isHitComboAllowed &&
                !n.isHitComboAllowed(v, l);
            p || (d = Gc(v, l, c.pluginHooks.dateSelectionTransformers)),
              (!d || !_u(d, l.dateProfile, c)) && ((f = !0), (d = null));
          }
          d
            ? c.dispatch({ type: "SELECT_DATES", selection: d })
            : u || c.dispatch({ type: "UNSELECT_DATES" }),
            f ? $t() : Kt(),
            u || (n.dragSelection = d);
        }),
        (n.handlePointerUp = function (l) {
          n.dragSelection &&
            (aa(n.dragSelection, l, n.component.context),
            (n.dragSelection = null));
        });
      var a = r.component,
        i = a.context.options,
        o = (n.dragging = new Le(r.el));
      (o.touchScrollAllowed = !1),
        (o.minDistance = i.selectMinDistance || 0),
        (o.autoScroller.isEnabled = i.dragScroll);
...
function zc(t) {
  var e = t.context.options,
    r = e.selectLongPressDelay;
  return r == null && (r = e.longPressDelay), r;
}
function Gc(t, e, r) {
  var n = t.dateSpan,
    a = e.dateSpan,
    i = [n.range.start, n.range.end, a.range.start, a.range.end];
  i.sort(qi);
...
var Qa = (function (t) {
  ...
  function e(r) {
    ...
    (n.subjectEl = null),
      ...
      (n.handlePointerDown = function (l) {
        ...
        var S = (n.subjectSeg = Se(l.subjectEl)),
          g = (n.eventRange = S.eventRange),
          b = g.instance.instanceId;
        (n.relevantEvents = nr(E.getCurrentData().eventStore, b)),
          (f.minDistance = l.isTouch ? 0 : p.eventDragMinDistance),
          (f.delay = l.isTouch && b !== d.props.eventSelection ? Yc(d) : null),
          p.fixedMirrorParent
            ? (v.parentNode = p.fixedMirrorParent)
            : (v.parentNode = U(u, ".fc")),
          (v.revertDuration = p.dragRevertDuration);
        var D = d.isValidSegDownEl(u) && !U(u, ".fc-event-resizer");
        f.setIgnoreMove(!D),
          (n.isDragging =
            D && l.subjectEl.classList.contains("fc-event-draggable"));
      }),
      (n.handleDragStart = function (l) {
        var u = n.component.context,
          c = n.eventRange,
          d = c.instance.instanceId;
        l.isTouch
          ? d !== n.component.props.eventSelection &&
            u.dispatch({ type: "SELECT_EVENT", eventInstanceId: d })
          : u.dispatch({ type: "UNSELECT_EVENT" }),
          n.isDragging &&
            (u.calendarApi.unselect(l),
            u.emitter.trigger("eventDragStart", {
              el: n.subjectEl,
      ...
      (n.handleHitUpdate = function (l, u) {
        if (!!n.isDragging) {
          var c = n.relevantEvents,
            d = n.hitDragging.initialHit,
            f = n.component.context,
            v = null,
            p = null,
            E = null,
            S = !1,
            g = { affectedEvents: c, mutatedEvents: Y(), isEvent: !0 };
          if (l) {
            v = l.context;
            var b = v.options;
            f === v || (b.editable && b.droppable)
              ? ((p = qc(
                  d,
                  l,
                  v.getCurrentData().pluginHooks.eventDragMutationMassagers
                )),
                p &&
                  ((E = lr(c, v.getCurrentData().eventUiBases, p, v)),
                  (g.mutatedEvents = E),
                  Oa(g, l.dateProfile, v) ||
                    ((S = !0),
                    (p = null),
                    (E = null),
                    (g.mutatedEvents = Y()))))
          ...
          n.displayDrag(v, g),
            ...
            u ||
              (f === v && gt(d, l) && (p = null),
              n.dragging.setMirrorNeedsRevert(!p),
              n.dragging.setMirrorIsVisible(
                !l || !Bn(n.subjectEl).querySelector(".fc-event-mirror")
              ),
              (n.receivingContext = v),
              (n.validMutation = p),
              (n.mutatedRelevantEvents = E));
        }
      }),
      ...
      (n.handleDragEnd = function (l) {
        if (n.isDragging) {
          var u = n.component.context,
            c = u.viewApi,
            d = n,
            f = d.receivingContext,
            v = d.validMutation,
            p = n.eventRange.def,
            E = n.eventRange.instance,
            S = new N(u, p, E),
            g = n.relevantEvents,
            b = n.mutatedRelevantEvents,
            D = n.hitDragging.finalHit;
          if (
            (n.clearDrag(),
            u.emitter.trigger("eventDragStop", {
              el: n.subjectEl,
              event: S,
              jsEvent: l.origEvent,
              view: c,
            ...
            if (f === u) {
              var C = new N(
                u,
                b.defs[p.defId],
                E ? b.instances[E.instanceId] : null
              );
              u.dispatch({ type: "MERGE_EVENTS", eventStore: b });
              for (
                var k = {
                    oldEvent: S,
                    event: C,
                    ...
                    revert: function () {
                      u.dispatch({ type: "MERGE_EVENTS", eventStore: g });
                    },
                  },
                  T = {},
                  P = 0,
                  _ = u.getCurrentData().pluginHooks.eventDropTransformers;
                P < _.length;
                P++
              ) {
                var O = _[P];
              ...
              u.emitter.trigger(
                ...
                u.emitter.trigger("eventChange", k);
            } else if (f) {
              var L = {
                event: S,
              ...
              u.emitter.trigger(
                "eventLeave",
                h(h({}, L), { draggedEl: l.subjectEl, view: c })
              ),
                u.dispatch({ type: "REMOVE_EVENTS", eventStore: g }),
                u.emitter.trigger("eventRemove", L);
              var Z = b.defs[p.defId],
                z = b.instances[E.instanceId],
                Ve = new N(f, Z, z);
              f.dispatch({ type: "MERGE_EVENTS", eventStore: b });
              var Ue = {
                event: Ve,
                relatedEvents: oe(b, f, z),
                revert: function () {
                  f.dispatch({ type: "REMOVE_EVENTS", eventStore: b });
                },
              };
              f.emitter.trigger("eventAdd", Ue),
                l.isTouch &&
                  f.dispatch({
                    type: "SELECT_EVENT",
          ...
          } else u.emitter.trigger("_noEventDrop");
        }
        n.cleanup();
      });
    var a = n.component,
  ...
  return (
    ...
    (e.SELECTOR = ".fc-event-draggable, .fc-event-resizable"),
    e
  );
})(we);
function qc(t, e, r) {
  ...
  n.allDay !== a.allDay &&
    ((s.allDay = a.allDay),
    (s.hasEnd = e.context.options.allDayMaintainDuration),
    a.allDay && (i = H(i)));
  var l = pe(
    i,
    o,
  ...
  for (
    var u = { datesDelta: l, standardProps: s }, c = 0, d = r;
    c < d.length;
    c++
  ) {
    var f = d[c];
...
var jc = (function (t) {
  ...
  function e(r) {
    ...
    (n.draggingSegEl = null),
      ...
      (n.validMutation = null),
      (n.mutatedRelevantEvents = null),
      (n.handlePointerDown = function (s) {
        var l = n.component,
          u = n.querySegEl(s),
          c = Se(u),
          d = (n.eventRange = c.eventRange);
        (n.dragging.minDistance = l.context.options.eventDragMinDistance),
          n.dragging.setIgnoreMove(
            !n.component.isValidSegDownEl(s.origEvent.target) ||
              (s.isTouch &&
                n.component.props.eventSelection !== d.instance.instanceId)
          );
      }),
      (n.handleDragStart = function (s) {
        var l = n.component.context,
          u = n.eventRange;
        n.relevantEvents = nr(
      ...
      (n.handleHitUpdate = function (s, l, u) {
        var c = n.component.context,
          d = n.relevantEvents,
          f = n.hitDragging.initialHit,
          v = n.eventRange.instance,
          p = null,
          E = null,
          S = !1,
          g = { affectedEvents: d, mutatedEvents: Y(), isEvent: !0 };
        if (s) {
          var b =
            s.componentId === f.componentId &&
            n.isHitComboAllowed &&
            !n.isHitComboAllowed(f, s);
          b ||
            (p = Zc(
              f,
              s,
              u.subjectEl.classList.contains("fc-event-resizer-start"),
              v.range
            ));
        }
        p &&
          ((E = lr(d, c.getCurrentData().eventUiBases, p, c)),
          (g.mutatedEvents = E),
          Oa(g, s.dateProfile, c) ||
            ((S = !0), (p = null), (E = null), (g.mutatedEvents = null))),
          E
            ? c.dispatch({ type: "SET_EVENT_RESIZE", state: g })
            : c.dispatch({ type: "UNSET_EVENT_RESIZE" }),
          S ? $t() : Kt(),
          l ||
            (p && gt(f, s) && (p = null),
            (n.validMutation = p),
      ...
      (n.handleDragEnd = function (s) {
        ...
        if (
          ...
          var p = new N(
            l,
            v.defs[u.defId],
            c ? v.instances[c.instanceId] : null
          );
          l.dispatch({ type: "MERGE_EVENTS", eventStore: v });
          var E = {
            oldEvent: d,
            event: p,
          ...
          l.emitter.trigger(
            ...
            h(h({}, E), {
              el: n.draggingSegEl,
              startDelta: n.validMutation.startDelta || I(0),
              endDelta: n.validMutation.endDelta || I(0),
              jsEvent: s.origEvent,
              view: l.viewApi,
            })
          ),
    ...
    var a = r.component,
      i = (n.dragging = new Le(r.el));
    (i.pointer.selector = ".fc-event-resizer"),
      (i.touchScrollAllowed = !1),
      (i.autoScroller.isEnabled = a.context.options.dragScroll);
    var o = (n.hitDragging = new ht(n.dragging, gr(r)));
    return (
      o.emitter.on("pointerdown", n.handlePointerDown),
      o.emitter.on("dragstart", n.handleDragStart),
      o.emitter.on("hitupdate", n.handleHitUpdate),
...
function Zc(t, e, r, n) {
  var a = t.context.dateEnv,
    i = t.dateSpan.range.start,
    o = e.dateSpan.range.start,
    s = pe(i, o, a, t.largeUnit);
  if (r) {
    if (a.add(n.start, s) < n.end) return { startDelta: s };
  } else if (a.add(n.end, s) > n.start) return { endDelta: s };
  return null;
}
var Xc = (function () {
    function t(e) {
      ...
      (this.context = e),
        ...
        (this.onDocumentPointerDown = function (a) {
          var i = r.context.options.unselectCancel,
            o = Wn(a.origEvent);
          (r.matchesCancel = !!U(o, i)), (r.matchesEvent = !!U(o, Qa.SELECTOR));
        }),
    ...
    (n.shouldIgnoreMove = !1),
      ...
      (n.handlePointerDown = function (i) {
        n.emitter.trigger("pointerdown", i),
          n.shouldIgnoreMove || n.emitter.trigger("dragstart", i);
      }),
      (n.handlePointerMove = function (i) {
        n.shouldIgnoreMove || n.emitter.trigger("dragmove", i);
      }),
      (n.handlePointerUp = function (i) {
        n.emitter.trigger("pointerup", i),
          n.shouldIgnoreMove || n.emitter.trigger("dragend", i);
      });
    var a = (n.pointer = new Er(r));
    return (
      a.emitter.on("pointerdown", n.handlePointerDown),
      a.emitter.on("pointermove", n.handlePointerMove),
...
var Jc = te({
  componentInteractions: [Bc, Fc, Qa, jc],
  calendarInteractions: [Xc],
  elementDraggingImpl: Le,
  optionRefiners: $c,
  listenerRefiners: Kc,
});
const Qc = { id: "calendar" },
  ed = Dn({
    __name: "index",
    props: {
      ...
      events: {
        ...
        default: () => [
          ...
          { title: "\u73A9\u7535\u8111", start: "2022-8-10", end: "2022-8-11" },
        ],
      },
      displayEventEnd: { type: Boolean, default: !0 },
  ...
  rd = Dn({
    ...
    setup(t) {
      let e = Cn([
        ...
        { title: "\u73A9\u7535\u8111", start: "2023-3-28", end: "2023-4-11" },
      ]);
      const r = (i) => {
          e.value.push({
            title: "\u5B66\u4E60",
            start: i.dateStr + "12:00",
            end: i.dateStr + "18:00",
          });
        },
        n = (i) => {
