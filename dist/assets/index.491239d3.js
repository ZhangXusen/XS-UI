    ...
    setup(F, { emit: v }) {
      ...
      return (
        f(
          ...
          (o) => {
            if (o) {
              let d = A.value.find((a) => a.name === n.value).children;
              (u.value = d), (c.value = ""), (l.value = "");
            }
          }
        ),
        f(
          ...
          (o) => {
            if (o) {
              let d = u.value.find((a) => a.name === c.value).children;
              (p.value = d), (l.value = "");
            }
          }
        ),
        f(
          ...
          (o) => {
            if (o) {
              let d = {
                  code: n.value && x.find((e) => e.name === n.value).code,
                  name: n.value,
                },
                a = {
                  code: c.value && u.value.find((e) => e.name === c.value).code,
                  name: c.value,
                },
                h = {
                  code:
                    o &&
                    c.value &&
                    p.value.find((e) => e.name === l.value).code,
                  name: o,
                };
              v("change", { province: d, city: a, area: h });
            }
          }
        ),
        (o, d) => {
            ...
            t("div", null, [
                    ...
                    t(
                      ...
                      y(
                        ...
                        (e) => (
                          ...
                          s(
                            a,
                            { value: e.name, key: e.code },
                            { default: i(() => [V(g(e.name), 1)]), _: 2 },
                            1032,
                            ["value"]
                          )
                        )
                    ...
                    t(
                      ...
                      y(
                        ...
                        (e) => (
                          ...
                          s(
                            a,
                            { key: e.code, value: e.name, label: e.name },
                            { default: i(() => [V(g(e.name), 1)]), _: 2 },
                            1032,
                            ["value", "label"]
                          )
              ...
              _(
                h,
                {
                  ...
                  placeholder: "\u8BF7\u9009\u62E9\u533A\u57DF",
                  modelValue: l.value,
                  "onUpdate:modelValue": d[2] || (d[2] = (e) => (l.value = e)),
                  clearable: "",
                },
                {
                  default: i(() => [
